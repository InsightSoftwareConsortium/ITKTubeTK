...
int itktubeRadiusExtractor2Test2( int argc, char * argv[] )
{
  if( argc != 3 )
    {
    std::cout
      << "itktubeRadiusExtractor2Test2 <inputImage> <vessel.tre>"
      << std::endl;
    return EXIT_FAILURE;
    }
