                ...
                const FloatOffsetType& itkNotUsed(offset) )
{
  ...
  this->ComputeDiffusionFirstDerivative( tensorNeighborhood, gd );
     ...
     DerivativeMatrixImageRegionType &tensorDerivativeRegion ) const
{
  tensorDerivativeRegion.Set(
      this->ComputeDiffusionFirstDerivative( tensorNeighborhood, NULL ) );
}

template< class TImageType >
void
AnisotropicDiffusionTensorFunction< TImageType >
::ComputeIntensityFirstAndSecondDerivatives(
