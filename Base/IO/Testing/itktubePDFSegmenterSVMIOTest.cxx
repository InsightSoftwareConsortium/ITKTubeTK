...
int itktubePDFSegmenterSVMIOTest( int argc, char * argv[] )
{
  if( argc != 8 )
    {
  ...
  typedef itk::tube::PDFSegmenterSVM< ImageType, ImageType >
    FilterType;
  ...
  itk::tube::PDFSegmenterSVMIO< ImageType, ImageType > PDFIO( filter );
  ...
  itk::tube::PDFSegmenterSVMIO< ImageType, ImageType > PDFIO2( filter2 );
  ...
  itk::tube::PDFSegmenterSVMIO< ImageType, ImageType > PDFIO3( filter2 );
  PDFIO.Write( argv[7] );
