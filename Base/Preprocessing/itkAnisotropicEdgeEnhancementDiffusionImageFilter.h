 ...
 * \brief This class iteratively enhances edge in an image by solving
 * non-linear diffusion equation developed.
 *
 * 
...
public:
  ...
  typedef AnisotropicEdgeEnhancementDiffusionFunction<InputImageType>  
...
private:
  ...
  struct DenseFDThreadStruct
    {
    AnisotropicEdgeEnhancementDiffusionImageFilter *Filter;
