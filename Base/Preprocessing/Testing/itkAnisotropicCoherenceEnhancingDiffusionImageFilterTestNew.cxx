...
int itkAnisotropicCoherenceEnhancingDiffusionImageFilterTestNew(int argc, char* argv []  ) 
{
  ...
  if( argc > 5 ) 
    {
    double contrastParamter = atof( argv[5] );
  ...
  if( argc > 7 ) 
    {
    double numberOfIterations = atoi(argv[7]);
