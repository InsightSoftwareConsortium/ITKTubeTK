/*=========================================================================
  ...
  Module:    $RCSfile: itkConvertImageFilter.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkConvertImageFilter_h
#define __itkConvertImageFilter_h
...
/** \class ConvertImageFilter
 * \brief Applies a linear transformation to the intensity levels of the
 * input Image. 
 *
 * ConvertImageFilter applies pixel-wise a linear transformation
...
class ITK_EXPORT ConvertImageFilter :
    public
...
public:
  ...
  typedef ConvertImageFilter      Self;
  ...
  itkTypeMacro(ConvertImageFilter, 
...
protected:
  ConvertImageFilter();
  virtual ~ConvertImageFilter() {};

private:
  ConvertImageFilter(const Self&); //purposely not implemented
...
#include "itkConvertImageFilter.txx"
#endif
