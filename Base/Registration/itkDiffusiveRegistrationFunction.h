...
=========================================================================*/
#ifndef __itkDiffusiveRegistrationFunction_h
#define __itkDiffusiveRegistrationFunction_h
...
/** \class itkDiffusiveRegistrationFunction
 * \brief Implements the update function for the
 * itkDiffusiveRegistrationFilter
 *
...
class ITK_EXPORT DiffusiveRegistrationFunction
...
public:
  ...
  typedef DiffusiveRegistrationFunction              Self;
...
protected:
  ...
  virtual ~DiffusiveRegistrationFunction() {}
...
private:
  ...
  DiffusiveRegistrationFunction(const Self&);
...
# include "Templates/itkDiffusiveRegistrationFunction+-.h"
#endif

#if ITK_TEMPLATE_TXX
# include "itkDiffusiveRegistrationFunction.txx"
#endif
