/*=========================================================================
  ...
  Program:   itkUNC
  Module:    $RCSfile: itkTubeToTubeTransformFilter.h,v $
  Language:  C++
 ...
 *  \warning Transform Class MUST have a proper implementation of ::TransformCovariantVector()
...
public:
  ...
  typedef typename GroupType::ConstPointer  GroupConstPointer;
  typedef VesselTubeSpatialObject<TDimension>     TubeType;
  typedef typename TubeType::Pointer        TubePointer;
  typedef typename TubeType::ConstPointer   TubeConstPointer;

  typedef SpatialObjectToSpatialObjectFilter<GroupType,GroupType> Superclass;
...
private:
  ...
  GroupConstPointer      m_TransformAsGroup;
  TransformPointer       m_Transform;
  GroupPointer           m_Output;
  double                 m_Scale;
  bool                   m_Crop;
