...
DoIt(int argc, char * argv[])
{
  ...
  tube::CLIProgressReporter progressReporter("HybridEnhancingAnisotropicDiffusion", CLPProcessInformation);
  ...
  typedef itk::tube::AnisotropicHybridDiffusionImageFilter<FilterInputImageType, FilterOutputImageType>
    HybridEnhancingFilterType;

  // Create a hybrid enhancing Filter
  typename HybridEnhancingFilterType::Pointer HybridEnhancingFilter = HybridEnhancingFilterType::New();
