...
DoIt(int argc, char * argv[])
{
  ...
  tube::CLIProgressReporter progressReporter("Compute Tube Measures", CLPProcessInformation);
  progressReporter.Start();

  typedef TPixel InputPixelType;

  typedef tube::ComputeTubeMeasures<InputPixelType, VDimension> FilterType;
