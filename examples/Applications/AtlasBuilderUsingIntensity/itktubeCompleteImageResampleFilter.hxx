...
template <class TInputImage, class TOutputImage, class TNonSingularTransform, class TInterpolatorPrecisionType>
void
CompleteImageResampleFilter<TInputImage, TOutputImage, TNonSingularTransform, TInterpolatorPrecisionType>::PrintSelf(
  std::ostream & os,
  Indent         indent) const
{
...
template <class TInputImage, class TOutputImage, class TNonSingularTransform, class TInterpolatorPrecisionType>
void
CompleteImageResampleFilter<TInputImage, TOutputImage, TNonSingularTransform, TInterpolatorPrecisionType>::GenerateData(
  void)
{
