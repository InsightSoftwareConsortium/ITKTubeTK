...
MinimizeImageSizeFilter<TInputImage>::MinimizeImageSizeFilter(void)
  : m_BufferImage(false)
  , m_ThresholdValue(0)
...
template <class TInputImage>
void
MinimizeImageSizeFilter<TInputImage>::GenerateData(void)
{
...
template <class TInputImage>
void
MinimizeImageSizeFilter<TInputImage>::Get3DCroppedEndRegion(InputImageConstPointer input, RegionType & region)
{
...
template <class TInputImage>
void
MinimizeImageSizeFilter<TInputImage>::Get3DCroppedStartRegion(InputImageConstPointer input, RegionType & region)
{
  InputPixelType threshold = GetThresholdValue();
  bool           isThresAbove = this->GetThresholdAbove();
