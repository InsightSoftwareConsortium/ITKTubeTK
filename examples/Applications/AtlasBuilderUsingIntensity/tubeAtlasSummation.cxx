...
AtlasSummation ::AtlasSummation(void)
...
void
AtlasSummation ::AddImage(InputImageType::Pointer i)
{
...
void
AtlasSummation ::AddImage(InputImageType::Pointer image, TransformType::Pointer t)
{
  ...
  if (m_AdjustResampledImageSize || m_AdjustResampledImageOrigin)
  {
    ...
    image2 = TransformInputImage(image,
                                 identity,
  ...
  else // No adjustments or resampling
  {
    ...
    {
      image2 = TransformInputImage(
        image, t, m_MeanBuilder->GetOutputSize(), m_MeanBuilder->GetOutputSpacing(), m_MeanBuilder->GetOutputOrigin());
    }
  }
...
AtlasSummation::InputImagePointer
AtlasSummation ::TransformInputImage(InputImagePointer image,
...
void
AtlasSummation ::Start(InputImageType::Pointer)
{
  m_ImageNumber = 0;
}
...
AtlasSummation::InputImagePointer
AtlasSummation ::GetClippedImage(InputImagePointer image, TransformType::Pointer t)
{
  // The filter does only require output spacing ( not size or origin )
  // to run the resampling
  typedef itk::tube::CompleteImageResampleFilter<InputImageType, InputImageType, TransformType> ResampleImageFilterType;
...
bool
AtlasSummation ::UpdateOutputSizeParameter(SizeType & inputSize)
{
...
void
AtlasSummation ::WriteImage(MeanImageType::Pointer image, const std::string & file)
{
...
void
AtlasSummation ::WriteImage(ProcessImagePointer image, const std::string & file)
{
