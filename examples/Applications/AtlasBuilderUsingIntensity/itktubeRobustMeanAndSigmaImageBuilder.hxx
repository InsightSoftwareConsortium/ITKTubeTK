...
#ifndef itktubeRobustMeanAndSigmaImageBuilder_hxx
#define itktubeRobustMeanAndSigmaImageBuilder_hxx


template <class TInputImageType, class TOutputMeanImageType, class TOutputSigmaImageType>
RobustMeanAndSigmaImageBuilder<TInputImageType, TOutputMeanImageType, TOutputSigmaImageType>::
...
template <class TInputImageType, class TOutputMeanImageType, class TOutputSigmaImageType>
void
RobustMeanAndSigmaImageBuilder<TInputImageType, TOutputMeanImageType, TOutputSigmaImageType>::BuildProcessingImages(
  InputImagePointer image)
{
  ...
  ::tube::FmtInfoMessage("This is the lower list size: %d", lowerImages.size());
...
template <class TInputImageType, class TOutputMeanImageType, class TOutputSigmaImageType>
void
RobustMeanAndSigmaImageBuilder<TInputImageType, TOutputMeanImageType, TOutputSigmaImageType>::AddImage(
  InputImagePointer i)
{
...
template <class TInputImageType, class TOutputMeanImageType, class TOutputSigmaImageType>
void
RobustMeanAndSigmaImageBuilder<TInputImageType, TOutputMeanImageType, TOutputSigmaImageType>::SetMedianImages(
  InputImagePointer i)
{
...
template <class TInputImageType, class TOutputMeanImageType, class TOutputSigmaImageType>
void
RobustMeanAndSigmaImageBuilder<TInputImageType, TOutputMeanImageType, TOutputSigmaImageType>::SetLowerImages(
  InputImagePointer i)
{
  bool              isAscending = true;
  InputImagePointer image = GetImageCopy(i);
...
template <class TInputImageType, class TOutputMeanImageType, class TOutputSigmaImageType>
void
RobustMeanAndSigmaImageBuilder<TInputImageType, TOutputMeanImageType, TOutputSigmaImageType>::SetUpperImages(
  InputImagePointer i)
{
...
template <class TInputImageType, class TOutputMeanImageType, class TOutputSigmaImageType>
typename RobustMeanAndSigmaImageBuilder<TInputImageType, TOutputMeanImageType, TOutputSigmaImageType>::
  InputImageListType &
  RobustMeanAndSigmaImageBuilder<TInputImageType, TOutputMeanImageType, TOutputSigmaImageType>::AddToUpdateImageList(
    ...
    bool                 ListIsAscending)
{
  ...
  for (int i = 0; i < list.size(); i++)
  {
    ...
    while (!it_list.IsAtEnd() && !it_input.IsAtEnd())
    {
      ...
      if (this->GetThresholdInputImageBelowOn() && it_input.Get() <= this->GetThresholdInputImageBelow())
      {
...
template <class TInputImageType, class TOutputMeanImageType, class TOutputSigmaImageType>
typename RobustMeanAndSigmaImageBuilder<TInputImageType, TOutputMeanImageType, TOutputSigmaImageType>::InputImagePointer
RobustMeanAndSigmaImageBuilder<TInputImageType, TOutputMeanImageType, TOutputSigmaImageType>::GetImageCopy(
  InputImagePointer input)
{
...
template <class TInputImageType, class TOutputMeanImageType, class TOutputSigmaImageType>
void
RobustMeanAndSigmaImageBuilder<TInputImageType, TOutputMeanImageType, TOutputSigmaImageType>::FinalizeOutput(void)
{
  ...
  // possible region )
  ProcessIteratorType it_sum(sumImage, sumImage->GetLargestPossibleRegion());
  ProcessIteratorType it_sumSqr(sumSquareImage, sumSquareImage->GetLargestPossibleRegion());
  CountIteratorType   it_valid(validImages, validImages->GetLargestPossibleRegion());
  ...
  for (unsigned int i = 0; i < outlierImage; i++)
  {
    ...
    InputConstIteratorType it_lowInput(lowInputs[i], lowInputs[i]->GetLargestPossibleRegion());
    InputConstIteratorType it_highInput(highInputs[i], highInputs[i]->GetLargestPossibleRegion());
    ...
    while (!it_lowInput.IsAtEnd())
    {
      if (it_valid.Get() > 2 * outlierImage)
      {
        ...
        ProcessPixelType sumSqrValue = it_lowInput.Get() * it_lowInput.Get() + it_highInput.Get() * it_highInput.Get();
...
typename RobustMeanAndSigmaImageBuilder<TInputImageType, TOutputMeanImageType, TOutputSigmaImageType>::
  ...
  RobustMeanAndSigmaImageBuilder<TInputImageType, TOutputMeanImageType, TOutputSigmaImageType>::GetMedianImage(void)
{
  ...
  OutputMeanIteratorType it_median(medianImage, medianImage->GetLargestPossibleRegion());
  // Odd number
  if ((totalNumImages % 2))
  {
    InputConstIteratorType it_middle(lastLowerImage, lastLowerImage->GetLargestPossibleRegion());
    it_middle.GoToBegin();
    it_median.GoToBegin();
  ...
  {
    InputConstIteratorType                it_middle1(lastLowerImage, lastLowerImage->GetLargestPossibleRegion());
    typename InputImageType::ConstPointer prevLowerImage = lowerImages[numImages - 1];
    InputConstIteratorType                it_middle2(prevLowerImage, prevLowerImage->GetLargestPossibleRegion());
    ...
    {
      // Average the values
      OutputMeanPixelType median = (double(it_middle1.Get()) + double(it_middle2.Get())) / 2;
...
template <class TInputImageType, class TOutputMeanImageType, class TOutputSigmaImageType>
void
RobustMeanAndSigmaImageBuilder<TInputImageType, TOutputMeanImageType, TOutputSigmaImageType>::UpdateOutputImageSize(
  SizeType inputSize)
{
  if (!(this->GetIsProcessing()))
  {
