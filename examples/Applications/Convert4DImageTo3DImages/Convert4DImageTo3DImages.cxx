...
DoIt(int argc, char * argv[])
{
  ...
  tube::CLIProgressReporter progressReporter("Convert4DImageTo3DImages", CLPProcessInformation);
  ...
  typename InputImageType::RegionType inImRegion = inIm->GetLargestPossibleRegion();
  ...
  typename InputImageType::RegionType inImToOutImRegion = inIm->GetLargestPossibleRegion();
