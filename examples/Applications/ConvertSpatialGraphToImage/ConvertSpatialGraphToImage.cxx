...
DoIt(int argc, char * argv[])
{
  ...
  typedef tube::ConvertSpatialGraphToImage<CVTImageType, ImageType> ConvertSpatialGraphToImageFilterType;
  typename ConvertSpatialGraphToImageFilterType::Pointer filter = ConvertSpatialGraphToImageFilterType::New();
  ...
  vnl_matrix<double> adjacencyMatrix(numberOfCentroids_AdjMat, numberOfCentroids_AdjMat);
