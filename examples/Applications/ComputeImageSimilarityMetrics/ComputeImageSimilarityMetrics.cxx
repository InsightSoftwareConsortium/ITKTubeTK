...
DoIt(int argc, char * argv[])
{
  ...
  {
    tube::ErrorMessage("Error reading input image 1: " + std::string(err.GetDescription()));
    return EXIT_FAILURE;
  }
  ...
  {
    tube::ErrorMessage("Error reading input image 2: " + std::string(err.GetDescription()));
    return EXIT_FAILURE;
  }
