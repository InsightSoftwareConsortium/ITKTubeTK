...
DoIt(int argc, char * argv[])
{
  ...
  tube::CLIProgressReporter progressReporter("EdgeEnhancingAnisotropicDiffusion", CLPProcessInformation);
  ...
  typedef itk::OrientImageFilter<FilterInputImageType, FilterInputImageType> OrientInputFilterType;
  ...
  typedef tube::EnhanceEdgesUsingDiffusion<FilterInputImageType, FilterOutputImageType> EdgeEnhancementFilterType;

  // Create a edge enhancement Filter
  typename EdgeEnhancementFilterType::Pointer EdgeEnhancementFilter = EdgeEnhancementFilterType::New();
  ...
  {
    tube::ErrorMessage("Edge enhancing anisotropic diffusion: Exception caught: " + std::string(err.GetDescription()));
    timeCollector.Report();
    return EXIT_FAILURE;
  }
  ...
  typedef itk::CastImageFilter<FilterOutputImageType, OutputImageType> CastOutputImageFilterType;
  ...
  typedef itk::OrientImageFilter<OutputImageType, OutputImageType> OrientOutputFilterType;
