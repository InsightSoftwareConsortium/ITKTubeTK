...
DoIt(int argc, char * argv[])
{
  ...
  typedef tube::ConvertTubesToDensityImage<TPixel, Dimension> TubeToDensityImageBuilderType;
  ...
  tube::CLIProgressReporter progressReporter("tubeDensityImageRadiusBuilder", CLPProcessInformation);

  progressReporter.Start();
  progressReporter.Report(progress);

  typename TubeToDensityImageBuilderType::Pointer builder = TubeToDensityImageBuilderType::New();
