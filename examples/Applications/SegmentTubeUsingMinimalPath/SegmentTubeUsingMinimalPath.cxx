...
DoIt(int argc, char * argv[])
{
  ...
  tube::CLIProgressReporter progressReporter("Extract Minimal Path", CLPProcessInformation);
  ...
  typedef tube::SegmentTubeUsingMinimalPath<DimensionT, PixelType> FilterType;
  ...
  {
    tubeErrorMacro(<< "Error: Path must contain at only one Start Point");
  ...
  {
    tubeErrorMacro(<< "Error: Atmost one End/Target Point or Target"
