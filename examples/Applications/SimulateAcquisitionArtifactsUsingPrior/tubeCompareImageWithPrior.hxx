...
CompareImageWithPrior<TPixel, TDimension>::CompareImageWithPrior(void)
{
  m_VolImage = NULL;
  m_MaskImage = NULL;
...
template <class TPixel, unsigned int TDimension>
void
CompareImageWithPrior<TPixel, TDimension>::SetInput(typename ImageType::Pointer volImage)
{
  m_VolImage = volImage;
}
...
CompareImageWithPrior<TPixel, TDimension>::GetInput(void)
{
  return m_VolImage;
}
...
template <class TPixel, unsigned int TDimension>
void
CompareImageWithPrior<TPixel, TDimension>::SetMaskImage(typename ImageType::Pointer maskImage)
{
...
template <class TPixel, unsigned int TDimension>
typename itk::Image<float, TDimension>::Pointer
CompareImageWithPrior<TPixel, TDimension>::GetMaskImage(void)
{
  return m_MaskImage;
}
...
template <class TPixel, unsigned int TDimension>
typename itk::Image<float, TDimension>::Pointer
CompareImageWithPrior<TPixel, TDimension>::GetOutput(void)
{
...
template <class TPixel, unsigned int TDimension>
typename itk::Image<float, TDimension>::Pointer
CompareImageWithPrior<TPixel, TDimension>::GetOutputMaskImage(void)
{
...
template <class TPixel, unsigned int TDimension>
void
CompareImageWithPrior<TPixel, TDimension>::SetMetricMask(typename ImageType::Pointer metricMask)
{
...
template <class TPixel, unsigned int TDimension>
typename itk::Image<float, TDimension>::Pointer
CompareImageWithPrior<TPixel, TDimension>::GetMetricMask(void)
{
  return m_MetricMask;
}
...
template <class TPixel, unsigned int TDimension>
void
CompareImageWithPrior<TPixel, TDimension>::SetForeground(float foreground)
{
...
template <class TPixel, unsigned int TDimension>
void
CompareImageWithPrior<TPixel, TDimension>::SetBackground(float background)
{
...
template <class TPixel, unsigned int TDimension>
void
CompareImageWithPrior<TPixel, TDimension>::SetErode(int erode)
{
  m_Erode = erode;
}
...
template <class TPixel, unsigned int TDimension>
void
CompareImageWithPrior<TPixel, TDimension>::SetDilate(int dilate)
{
  m_Dilate = dilate;
}
...
template <class TPixel, unsigned int TDimension>
void
CompareImageWithPrior<TPixel, TDimension>::SetGaussianBlur(float gaussianBlur)
{
...
template <class TPixel, unsigned int TDimension>
void
CompareImageWithPrior<TPixel, TDimension>::SetSamplingRate(float samplingRate)
{
...
template <class TPixel, unsigned int TDimension>
void
CompareImageWithPrior<TPixel, TDimension>::SetSeed(unsigned int seed)
{
  m_Seed = seed;
}
...
template <class TPixel, unsigned int TDimension>
void
CompareImageWithPrior<TPixel, TDimension>::SetNormalize(bool normalize)
{
...
template <class TPixel, unsigned int TDimension>
void
CompareImageWithPrior<TPixel, TDimension>::SetUseRegistration(bool reg)
{
...
template <class TPixel, unsigned int TDimension>
bool
CompareImageWithPrior<TPixel, TDimension>::GetUseRegistration(void)
{
...
template <class TPixel, unsigned int TDimension>
void
CompareImageWithPrior<TPixel, TDimension>::SetUseRegistrationTransform(bool reg)
{
...
template <class TPixel, unsigned int TDimension>
bool
CompareImageWithPrior<TPixel, TDimension>::GetUseRegistrationTransform(void)
{
...
template <class TPixel, unsigned int TDimension>
void
CompareImageWithPrior<TPixel, TDimension>::SetUseRegistrationOptimization(bool reg)
{
...
template <class TPixel, unsigned int TDimension>
bool
CompareImageWithPrior<TPixel, TDimension>::GetUseRegistrationOptimization(void)
{
...
template <class TPixel, unsigned int TDimension>
void
CompareImageWithPrior<TPixel, TDimension>::SetRegistrationTransform(
  typename itk::RigidImageToImageRegistrationMethod<itk::Image<float, TDimension>>::TransformType::Pointer tfm)
{
  m_RegistrationTransform = tfm;
}

template <class TPixel, unsigned int TDimension>
typename itk::RigidImageToImageRegistrationMethod<itk::Image<float, TDimension>>::TransformType::Pointer
CompareImageWithPrior<TPixel, TDimension>::GetRegistrationTransform(void)
{
...
template <class TPixel, unsigned int TDimension>
void
CompareImageWithPrior<TPixel, TDimension>::SetBoundarySize(std::vector<int> & boundarySize)
{
...
template <class TPixel, unsigned int TDimension>
void
CompareImageWithPrior<TPixel, TDimension>::SetTimeCollector(itk::TimeProbesCollectorBase * timeCollector)
{
...
template <class TPixel, unsigned int TDimension>
void
CompareImageWithPrior<TPixel, TDimension>::SetProgressReporter(tube::CLIProgressReporter * progressReporter,
                                                               float                       progressStart,
                                                               float                       progressRange)
{
...
template <class TPixel, unsigned int TDimension>
void
CompareImageWithPrior<TPixel, TDimension>::Update(void)
{
  ...
  if (m_Erode > 0)
  {
    ...
    typedef itk::BinaryBallStructuringElement<PixelType, TDimension> BallType;
    BallType                                                         ball;
    ball.SetRadius(1);
  ...
  if (m_UseRegistration)
  {
    ...
    if (m_UseRegistrationOptimization)
    {
      ...
      {
        reg->SetInitialTransformParameters(m_RegistrationTransform->GetParameters());
      }
      typename ImageType::SizeType imageSize = m_OutputVolImage->GetLargestPossibleRegion().GetSize();
      for (unsigned int i = 0; i < TDimension; i++)
      {
      ...
      if (m_ProgressReporter)
      {
        tube::CLIFilterWatcher watcher(reg,
                                       "Registration",
      ...
      {
        tube::WarningMessage("Exception thrown during registration. Compensating...");
        m_RegistrationTransform = RegistrationMethodType::TransformType::New();
        m_RegistrationTransform->SetIdentity();
      }
      ...
      for (unsigned int i = 0; i < m_RegistrationTransform->GetNumberOfParameters(); i++)
      {
    ...
    typename NNInterpolatorType::Pointer                                    orgInterpolator = NNInterpolatorType::New();
  ...
  if (m_BoundarySize.size() > 0)
  {
    ...
    typename ImageType::SizeType roiSize = m_OutputVolImage->GetLargestPossibleRegion().GetSize();
    ...
    typename CropFilterType::Pointer                   cropInputFilter = CropFilterType::New();
    typename CropFilterType::Pointer                   cropMaskFilter = CropFilterType::New();
    typename CropFilterType::Pointer                   cropRegMaskFilter = CropFilterType::New();
  ...
  if (m_Normalize)
  {
    ...
    IterType                                    volIter(m_OutputVolImage, m_OutputVolImage->GetLargestPossibleRegion());
    IterType maskIter(m_OutputMaskImage, m_OutputMaskImage->GetLargestPossibleRegion());
    IterType regMaskIter(regMaskImage, regMaskImage->GetLargestPossibleRegion());
  ...
  itk::ImageRegionIteratorWithIndex<ImageType> volIter(m_OutputVolImage, m_OutputVolImage->GetLargestPossibleRegion());
  itk::ImageRegionIteratorWithIndex<ImageType> maskIter(m_OutputMaskImage,
  ...
  while (!volIter.IsAtEnd())
  {
    ...
    {
      valid = false;
      m_OutputVolImage->TransformIndexToPhysicalPoint(volIter.GetIndex(), pnt);
...
template <class TPixel, unsigned int TDimension>
float
CompareImageWithPrior<TPixel, TDimension>::GetGoodnessOfFit(void)
{
  return m_GoF;
}
