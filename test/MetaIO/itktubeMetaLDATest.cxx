...
int
itktubeMetaLDATest(int argc, char * argv[])
{
  if (argc != 2)
  {
  ...
  if (mlda1.GetLDAValues() != v || mlda1.GetLDAMatrix() != m || mlda1.GetInputWhitenMeans() != wm ||
      mlda1.GetInputWhitenStdDevs() != ws || mlda1.GetOutputWhitenMeans() != ws || mlda1.GetOutputWhitenStdDevs() != wm)
  {
  ...
  if (mlda2.GetLDAValues() != mlda1.GetLDAValues() || mlda2.GetInputWhitenMeans() != mlda1.GetInputWhitenMeans() ||
      mlda2.GetInputWhitenStdDevs() != mlda1.GetInputWhitenStdDevs() ||
      mlda2.GetOutputWhitenMeans() != mlda1.GetOutputWhitenMeans() ||
      mlda2.GetOutputWhitenStdDevs() != mlda1.GetOutputWhitenStdDevs() || mlda2.GetLDAMatrix() != mlda1.GetLDAMatrix())
  {
  ...
  if (mlda3.GetLDAValues() != mlda1.GetLDAValues() || mlda3.GetInputWhitenMeans() != mlda1.GetInputWhitenMeans() ||
      mlda3.GetInputWhitenStdDevs() != mlda1.GetInputWhitenStdDevs() ||
      mlda3.GetOutputWhitenMeans() != mlda1.GetOutputWhitenMeans() ||
      mlda3.GetOutputWhitenStdDevs() != mlda1.GetOutputWhitenStdDevs() || mlda3.GetLDAMatrix() != mlda1.GetLDAMatrix())
  {
  ...
  if (mlda4.GetLDAValues() != mlda1.GetLDAValues() || mlda4.GetInputWhitenMeans() != mlda1.GetInputWhitenMeans() ||
      mlda4.GetInputWhitenStdDevs() != mlda1.GetInputWhitenStdDevs() ||
      mlda4.GetOutputWhitenMeans() != mlda1.GetOutputWhitenMeans() ||
      mlda4.GetOutputWhitenStdDevs() != mlda1.GetOutputWhitenStdDevs() || mlda4.GetLDAMatrix() != mlda1.GetLDAMatrix())
  {
  ...
  if (mlda5.GetLDAValues() != mlda1.GetLDAValues() || mlda5.GetInputWhitenMeans() != mlda1.GetInputWhitenMeans() ||
      mlda5.GetInputWhitenStdDevs() != mlda1.GetInputWhitenStdDevs() ||
      mlda5.GetOutputWhitenMeans() != mlda1.GetOutputWhitenMeans() ||
      mlda5.GetOutputWhitenStdDevs() != mlda1.GetOutputWhitenStdDevs() || mlda5.GetLDAMatrix() != mlda1.GetLDAMatrix())
  {
