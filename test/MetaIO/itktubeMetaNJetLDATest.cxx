...
int
itktubeMetaNJetLDATest(int argc, char * argv[])
{
  if (argc != 2)
  {
  ...
  mlda1.SetNumberOfLDABasisToUseAsFeatures(4);
  mlda1.SetNumberOfPCABasisToUseAsFeatures(6);
  ...
  if (mlda1.GetLDAValues() != v || mlda1.GetLDAMatrix() != m || mlda1.GetZeroScales() != scales0 ||
      mlda1.GetFirstScales() != scales1 || mlda1.GetSecondScales() != scales2 || mlda1.GetRidgeScales() != scalesR)
  {
  ...
  if (mlda2.GetLDAValues() != mlda1.GetLDAValues() || mlda2.GetLDAMatrix() != mlda1.GetLDAMatrix() ||
      ...
      mlda2.GetZeroScales() != mlda1.GetZeroScales() || mlda2.GetFirstScales() != mlda1.GetFirstScales() ||
      mlda2.GetSecondScales() != mlda1.GetSecondScales() || mlda2.GetRidgeScales() != mlda1.GetRidgeScales())
  {
  ...
  itk::tube::MetaNJetLDA mlda3(scales0, scales1, scales2, scalesR, 4, 6, v, m, wm, ws, ws, wm);
  if (mlda3.GetLDAValues() != mlda1.GetLDAValues() || mlda3.GetLDAMatrix() != mlda1.GetLDAMatrix() ||
      ...
      mlda3.GetOutputWhitenStdDevs() != mlda1.GetOutputWhitenStdDevs() || mlda3.GetZeroScales() != scales0 ||
      mlda3.GetFirstScales() != scales1 || mlda3.GetSecondScales() != scales2 || mlda3.GetRidgeScales() != scalesR)
  {
  ...
  if (mlda4.GetLDAValues() != mlda1.GetLDAValues() || mlda4.GetLDAMatrix() != mlda1.GetLDAMatrix() ||
      ...
      mlda4.GetOutputWhitenStdDevs() != mlda1.GetOutputWhitenStdDevs() || mlda4.GetZeroScales() != scales0 ||
      mlda4.GetFirstScales() != scales1 || mlda4.GetSecondScales() != scales2 || mlda4.GetRidgeScales() != scalesR)
  {
  ...
  mlda5.InitializeEssential(scales0, scales1, scales2, scalesR, 4, 6, v, m, wm, ws, ws, wm);
  if (mlda5.GetLDAValues() != mlda1.GetLDAValues() || mlda5.GetLDAMatrix() != mlda1.GetLDAMatrix() ||
      ...
      mlda5.GetOutputWhitenStdDevs() != mlda1.GetOutputWhitenStdDevs() || mlda5.GetZeroScales() != scales0 ||
      mlda5.GetFirstScales() != scales1 || mlda5.GetSecondScales() != scales2 || mlda5.GetRidgeScales() != scalesR)
  {
    std::cout << "LDA values do not match after initialize essential." << std::endl;
    return EXIT_FAILURE;
  }
  ...
  if (mlda5.GetLDAValues() != mlda1.GetLDAValues() || mlda5.GetLDAMatrix() != mlda1.GetLDAMatrix() ||
      ...
      mlda5.GetInputWhitenStdDevs() != mlda1.GetInputWhitenStdDevs() ||
      mlda5.GetOutputWhitenMeans() != mlda1.GetOutputWhitenMeans() ||
      mlda5.GetOutputWhitenStdDevs() != mlda1.GetOutputWhitenStdDevs() || mlda1.GetZeroScales() != scales0 ||
      mlda1.GetFirstScales() != scales1 || mlda1.GetSecondScales() != scales2 || mlda1.GetRidgeScales() != scalesR)
  {
