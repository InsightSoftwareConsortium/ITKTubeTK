...
int
itktubeMetaClassPDFTest(int argc, char * argv[])
{
  if (argc != 2)
  {
  ...
  if (pdf1.GetNumberOfFeatures() != pdf2.GetNumberOfFeatures() ||
      pdf1.GetNumberOfBinsPerFeature()[0] != pdf2.GetNumberOfBinsPerFeature()[0] ||
      pdf1.GetNumberOfBinsPerFeature()[1] != pdf2.GetNumberOfBinsPerFeature()[1] ||
      pdf1.GetBinMin()[0] != pdf2.GetBinMin()[0] || pdf1.GetBinMin()[1] != pdf2.GetBinMin()[1] ||
      pdf1.GetBinSize()[0] != pdf2.GetBinSize()[0] || pdf1.GetBinSize()[1] != pdf2.GetBinSize()[1])
  {
    std::cout << pdf2.GetBinMin()[0] << ", " << pdf2.GetBinMin()[1] << std::endl;
    std::cout << pdf2.GetBinSize()[0] << ", " << pdf2.GetBinSize()[1] << std::endl;
  ...
  if (pdf1.GetHistogramSmoothingStandardDeviation() != pdf2.GetHistogramSmoothingStandardDeviation())
  {
    std::cout << "HistogramSmoothingStandardDeviation Initialize failed" << std::endl;
    result = EXIT_FAILURE;
  }
  if (pdf1.GetProbabilityImageSmoothingStandardDeviation() != pdf2.GetProbabilityImageSmoothingStandardDeviation())
  {
    std::cout << "ProbabilityImageSmoothingStandardDeviation Initialize failed" << std::endl;
    result = EXIT_FAILURE;
  }
  ...
  if (pdf1.GetReclassifyNotObjectLabels() != pdf2.GetReclassifyNotObjectLabels())
  {
  ...
  if (pdf1.GetNumberOfFeatures() != pdf3.GetNumberOfFeatures() ||
      pdf1.GetNumberOfBinsPerFeature()[0] != pdf3.GetNumberOfBinsPerFeature()[0] ||
      pdf1.GetNumberOfBinsPerFeature()[1] != pdf3.GetNumberOfBinsPerFeature()[1] ||
      pdf1.GetBinMin()[0] != pdf3.GetBinMin()[0] || pdf1.GetBinMin()[1] != pdf3.GetBinMin()[1] ||
      pdf1.GetBinSize()[0] != pdf3.GetBinSize()[0] || pdf1.GetBinSize()[1] != pdf3.GetBinSize()[1])
  {
