...
int
itktubeRidgeSeedFilterIOTest(int argc, char * argv[])
{
  ...
  if (argc != 6)
  {
    ...
    std::cerr << argv[0] << " inputImage labelmapImage outputImage fileIO outputImage2" << std::endl;
    return EXIT_FAILURE;
  }
  ...
  itk::tube::RidgeSeedFilterIO<ImageType, LabelMapType> filterIO(filter);
  ...
  itk::tube::RidgeSeedFilterIO<ImageType, LabelMapType> filterIO2(filter2);
  ...
  itk::tube::RidgeSeedFilterIO<ImageType, LabelMapType> filterIO3(filter2);
