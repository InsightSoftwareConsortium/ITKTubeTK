...
int
itktubeAnisotropicCoherenceEnhancingDiffusionImageFilterTest(int argc, char * argv[])
{
  if (argc < 3)
  {
  ...
  typedef itk::tube::AnisotropicCoherenceEnhancingDiffusionImageFilter<InputImageType, OutputImageType>
    CoherenceEnhancingFilterType;

  // Create a edge enhancement Filter
  CoherenceEnhancingFilterType::Pointer CoherenceEnhancingFilter = CoherenceEnhancingFilterType::New();
