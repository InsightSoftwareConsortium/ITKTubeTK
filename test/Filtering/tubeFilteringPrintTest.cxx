...
int
tubeFilteringPrintTest(int itkNotUsed(argc), char * itkNotUsed(argv)[])
{
  const unsigned int                        Dimension = 3;
  typedef itk::Image<float, Dimension>      ImageType;
  typedef itk::TubeSpatialObject<Dimension> TubeSpatialObjectType;

  itk::tube::AnisotropicCoherenceEnhancingDiffusionImageFilter<ImageType, ImageType>::Pointer acedif =
    itk::tube::AnisotropicCoherenceEnhancingDiffusionImageFilter<ImageType, ImageType>::New();
  std::cout << "-------------acedif" << acedif << std::endl;

  itk::tube::AnisotropicDiffusionTensorFunction<ImageType>::Pointer adtf =
    itk::tube::AnisotropicDiffusionTensorFunction<ImageType>::New();
  std::cout << "-------------adtf" << adtf << std::endl;

  itk::tube::AnisotropicEdgeEnhancementDiffusionImageFilter<ImageType, ImageType>::Pointer aeedif =
    itk::tube::AnisotropicEdgeEnhancementDiffusionImageFilter<ImageType, ImageType>::New();
  std::cout << "-------------aeedif" << aeedif << std::endl;

  itk::tube::AnisotropicHybridDiffusionImageFilter<ImageType, ImageType>::Pointer ahdif =
    itk::tube::AnisotropicHybridDiffusionImageFilter<ImageType, ImageType>::New();
  std::cout << "-------------ahdif" << ahdif << std::endl;

  typedef itk::tube::CropImageFilter<ImageType, ImageType> CropImageFilter;
  ...
  ExtractTubePointsSpatialObjectFilterType::Pointer etpsof = ExtractTubePointsSpatialObjectFilterType::New();
  std::cout << "-------------etpsof" << etpsof << std::endl;

  typedef itk::tube::FFTGaussianDerivativeIFFTFilter<ImageType> FFTGaussianDerivativeIFFTFilter;
  FFTGaussianDerivativeIFFTFilter::Pointer                      fgdif = FFTGaussianDerivativeIFFTFilter::New();
  std::cout << "-------------fgdif " << fgdif << std::endl;

  typedef itk::tube::MinimumSpanningTreeVesselConnectivityFilter<Dimension> VesselConnectivityFilterType;
  VesselConnectivityFilterType::Pointer mstvcf = VesselConnectivityFilterType::New();
  ...
  itk::tube::StructureTensorRecursiveGaussianImageFilter<ImageType>::Pointer strgif =
    itk::tube::StructureTensorRecursiveGaussianImageFilter<ImageType>::New();
  ...
  typedef itk::tube::StructureTensorRecursiveGaussianImageFilter<ImageType>::OutputImageType
                                                                                    SymmetricSecondRankTensorImageType;
  itk::tube::SymmetricEigenVectorAnalysisImageFilter<SymmetricSecondRankTensorImageType,
                                                     EigenValueImageType,
  ...
  itk::tube::TubeEnhancingDiffusion2DImageFilter<float, 2>::Pointer vesselEnahncingObj =
    itk::tube::TubeEnhancingDiffusion2DImageFilter<float, 2>::New();
  std::cout << "-------------TubeEnhancingDiffusion2DImageFilter" << vesselEnahncingObj << std::endl;

  itk::tube::SheetnessMeasureImageFilter<float>::Pointer sheetnessMeasureImageFilterObj =
    itk::tube::SheetnessMeasureImageFilter<float>::New();
  std::cout << "-------------SheetnessMeasureImageFilter" << sheetnessMeasureImageFilterObj << std::endl;

  itk::tube::ShrinkWithBlendingImageFilter<ImageType, ImageType>::Pointer shrinkUsingMaxImageFilterObj =
    itk::tube::ShrinkWithBlendingImageFilter<ImageType, ImageType>::New();
  std::cout << "-------------ShrinkWithBlendingImageFilter" << shrinkUsingMaxImageFilterObj << std::endl;
