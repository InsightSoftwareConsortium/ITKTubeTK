...
tubeFilteringPrintTest(int itkNotUsed(argc), char * itkNotUsed(argv)[])
{
  ...
  using CropImageFilter = itk::tube::CropImageFilter<ImageType, ImageType>;
  ...
  using VesselConnectivityFilterType = itk::tube::MinimumSpanningTreeVesselConnectivityFilter<Dimension>;
