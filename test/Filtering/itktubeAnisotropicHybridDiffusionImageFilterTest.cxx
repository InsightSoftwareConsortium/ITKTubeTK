...
int
itktubeAnisotropicHybridDiffusionImageFilterTest(int argc, char * argv[])
{
  if (argc < 3)
  {
    std::cerr << "Missing Parameters: " << argv[0] << " Input_Image"
              ...
              << " [Hybrid contrast] "
              << " [Alpha] [Time step size] [ Number of Iterations]" << std::endl;
    return EXIT_FAILURE;
  }
  ...
  typedef itk::tube::AnisotropicHybridDiffusionImageFilter<InputImageType, OutputImageType> HybridFilterType;
