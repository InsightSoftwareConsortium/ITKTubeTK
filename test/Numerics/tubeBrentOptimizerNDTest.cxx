...
int
tubeBrentOptimizerNDTest(int tubeNotUsed(argc), char * tubeNotUsed(argv)[])
{
  ...
  {
    std::cout << "xMin should be -3.5 and not " << opt.GetXMin()[0] << std::endl;
  ...
  {
    std::cout << "xMax should be 3.5 and not " << opt.GetXMax()[0] << std::endl;
    returnStatus = EXIT_FAILURE;
  }
  ...
  {
    std::cout << "xStep should be 0.1 and not " << opt.GetXStep()[0] << std::endl;
    returnStatus = EXIT_FAILURE;
  }
  ...
  {
    std::cout << "tolerance should be 0.001 and not " << opt.GetTolerance() << std::endl;
    returnStatus = EXIT_FAILURE;
  }
  ...
  {
    std::cout << "maxIterations should be 100 and not " << opt.GetMaxIterations() << std::endl;
    returnStatus = EXIT_FAILURE;
  }
