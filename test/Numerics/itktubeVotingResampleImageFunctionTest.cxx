...
itktubeVotingResampleImageFunctionTest(int argc, char * argv[])
{
  ...
  typedef itk::AffineTransform<CoordinateType, Dimension>                   AffineTransformType;
  typedef itk::tube::VotingResampleImageFunction<ImageType, CoordinateType> InterpolatorType;
