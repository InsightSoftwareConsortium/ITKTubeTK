...
int
tubeParabolicFitOptimizer1DTest(int tubeNotUsed(argc), char * tubeNotUsed(argv)[])
{
  ...
  if (opt->GetXStep() != 0.1)
  {
    std::cout << "xStep should be 0.1 and not " << opt->GetXStep() << std::endl;
    returnStatus = EXIT_FAILURE;
  }
