...
class OptimizedImageToImageRegistrationMethod : public ImageToImageRegistrationMethod<TImage>
{
...
public:
  ...
  itkOverrideGetNameOfClassMacro(OptimizedImageToImageRegistrationMethod);
  ...
  enum InterpolationMethodEnumType
  {
