...
#ifndef itktubeSpatialObjectToImageRegistrationMethod_h
#define itktubeSpatialObjectToImageRegistrationMethod_h
...
public:
  ...
  using TransformType = Transform<double, ObjectDimension, Self::ImageDimension>;
