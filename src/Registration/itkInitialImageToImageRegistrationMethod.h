...
class InitialImageToImageRegistrationMethod : public ImageToImageRegistrationMethod<TImage>
{
...
public:
  ...
  itkOverrideGetNameOfClassMacro(InitialImageToImageRegistrationMethod);
