...
MergeAdjacentImagesFilter<TImage>::Update()
{
  ...
  else
  {
    ...
    {
      using MapFilterType =
        typename itk::GeneralizedDistanceTransformImageFilter<FloatImageType, FloatImageType, FloatImageType>;
    ...
    {
      using MapFilterType =
        typename itk::DanielssonDistanceMapImageFilter<FloatImageType, FloatImageType, FloatImageType>;
      typename MapFilterType::Pointer mapDistFilter = MapFilterType::New();
    ...
    if (m_UseFastBlending)
    {
      using MapFilterType = typename itk::GeneralizedDistanceTransformImageFilter<FloatImageType, FloatImageType>;
    ...
    else
    {
      ...
      using SignedMapFilterType = typename itk::SignedDanielssonDistanceMapImageFilter<FloatImageType, FloatImageType>;
