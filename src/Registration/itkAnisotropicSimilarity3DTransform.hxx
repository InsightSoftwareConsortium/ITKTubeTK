...
AnisotropicSimilarity3DTransform<TScalarType>::AnisotropicSimilarity3DTransform()
...
template <class TScalarType>
void
AnisotropicSimilarity3DTransform<TScalarType>::SetScale(ScaleType scale)
{
  m_Scale[0] = scale;
  m_Scale[1] = scale;
  m_Scale[2] = scale;
...
template <class TScalarType>
void
AnisotropicSimilarity3DTransform<TScalarType>::SetScale(VectorType scale)
{
  m_Scale[0] = scale[0];
  m_Scale[1] = scale[1];
  m_Scale[2] = scale[2];
...
template <class TScalarType>
void
AnisotropicSimilarity3DTransform<TScalarType>::SetMatrix(const MatrixType & matrix)
{
...
template <class TScalarType>
void
AnisotropicSimilarity3DTransform<TScalarType>::SetMatrix(const MatrixType & matrix, const double tolerance)
{
  //
  ...
  {
    itkExceptionMacro(<< "Attempting to set non-orthogonal matrix (after removing scaling)");
  }
...
template <class TScalarType>
void
AnisotropicSimilarity3DTransform<TScalarType>::SetParameters(const ParametersType & parameters)
{
...
AnisotropicSimilarity3DTransform<TScalarType>::GetParameters(void) const
{
...
AnisotropicSimilarity3DTransform<TScalarType>::GetJacobian(const InputPointType & p) const
{
...
template <class TScalarType>
void
AnisotropicSimilarity3DTransform<TScalarType>::ComputeMatrix()
{
...
template <class TScalarType>
void
AnisotropicSimilarity3DTransform<TScalarType>::ComputeMatrixParameters(void)
{
