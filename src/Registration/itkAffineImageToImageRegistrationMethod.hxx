...
AffineImageToImageRegistrationMethod<TImage>::AffineImageToImageRegistrationMethod(void)
{
...
AffineImageToImageRegistrationMethod<TImage>::GetTypedTransform(void)
{
...
AffineImageToImageRegistrationMethod<TImage>::GetTypedTransform(void) const
{
...
AffineImageToImageRegistrationMethod<TImage>::GetAffineTransform(void) const
{
...
template <class TImage>
void
AffineImageToImageRegistrationMethod<TImage>::SetInitialTransformParametersFromAffineTransform(
...
template <class TImage>
void
AffineImageToImageRegistrationMethod<TImage>::PrintSelf(std::ostream & os, Indent indent) const
{
