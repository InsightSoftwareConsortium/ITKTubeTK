                                                       ...
                                                       TResampleImagePointer &       resampledImage)
{
  ...
  using ResampleFilterType =
    itk::ResampleImageFilter<typename TResampleImagePointer::ObjectType, typename TResampleImagePointer::ObjectType>;
...
{
  // Do linear interpolation
  using ResampleFilterType = itk::ResampleImageFilter<typename TVectorResampleImagePointer::ObjectType,
  ...
  TDeformationComponentImageArray & deformationComponentImages)
{
  ...
  using VectorIndexSelectionFilterType =
    itk::VectorIndexSelectionCastImageFilter<TDeformationField,
