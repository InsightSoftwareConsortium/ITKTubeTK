 ...
 *
 *=========================================================================*/
#ifndef itkSpatialObjectToImageRegistrationMethod_h
#define itkSpatialObjectToImageRegistrationMethod_h
 ...
 *
 * The SpatialObjectToImageRegistrationMethod is different from the rest of the
...
class ITK_TEMPLATE_EXPORT SpatialObjectToImageRegistrationMethod : public ProcessObject
{
public:
  ITK_DISALLOW_COPY_AND_MOVE(SpatialObjectToImageRegistrationMethod);
  ...
  /**  Type of the metric. */
  using MetricType = SpatialObjectToImageMetric<FixedImageType, MovingSpatialObjectType>;
...
protected:
  ...
  ~SpatialObjectToImageRegistrationMethod() override = default;
  void
