...
#ifndef itktubeInitialSpatialObjectToImageRegistrationMethod_h
#define itktubeInitialSpatialObjectToImageRegistrationMethod_h
...
public:
  ...
  itkOverrideGetNameOfClassMacro(InitialSpatialObjectToImageRegistrationMethod);
