 ...
 *
 *=========================================================================*/
#ifndef itkSpatialObjectToImageRegistrationMethod_hxx
#define itkSpatialObjectToImageRegistrationMethod_hxx
...
SpatialObjectToImageRegistrationMethod<TMovingSpatialObject, TFixedImage>::SpatialObjectToImageRegistrationMethod()
{
...
template <typename TMovingSpatialObject, typename TFixedImage>
void
SpatialObjectToImageRegistrationMethod<TMovingSpatialObject, TFixedImage>::Initialize()
{
  if (!m_FixedImage)
  {
...
template <typename TMovingSpatialObject, typename TFixedImage>
void
SpatialObjectToImageRegistrationMethod<TMovingSpatialObject, TFixedImage>::GenerateData()
{
  try
  {
...
template <typename TMovingSpatialObject, typename TFixedImage>
const typename SpatialObjectToImageRegistrationMethod<TMovingSpatialObject, TFixedImage>::TransformOutputType *
SpatialObjectToImageRegistrationMethod<TMovingSpatialObject, TFixedImage>::GetOutput() const
{
...
template <typename TMovingSpatialObject, typename TFixedImage>
DataObject::Pointer
SpatialObjectToImageRegistrationMethod<TMovingSpatialObject, TFixedImage>::MakeOutput(
...
template <typename TMovingSpatialObject, typename TFixedImage>
ModifiedTimeType
SpatialObjectToImageRegistrationMethod<TMovingSpatialObject, TFixedImage>::GetMTime() const
{
...
template <typename TMovingSpatialObject, typename TFixedImage>
void
SpatialObjectToImageRegistrationMethod<TMovingSpatialObject, TFixedImage>::PrintSelf(std::ostream & os,
                                                                                     Indent         indent) const
{
