...
#ifndef itktubeScaleSkewAngle2DSpatialObjectToImageRegistrationMethod_h
#define itktubeScaleSkewAngle2DSpatialObjectToImageRegistrationMethod_h
...
public:
  ...
  itkOverrideGetNameOfClassMacro(ScaleSkewAngle2DSpatialObjectToImageRegistrationMethod);

  itkNewMacro(Self);

  static constexpr unsigned int ImageDimension = 2;
  static constexpr unsigned int ObjectDimension = 2;
