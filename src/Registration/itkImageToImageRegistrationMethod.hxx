...
#ifndef ImageToImageRegistrationMethod_hxx
#define ImageToImageRegistrationMethod_hxx
...
ImageToImageRegistrationMethod<TImage>::ImageToImageRegistrationMethod(void)
{
...
template <class TImage>
void
ImageToImageRegistrationMethod<TImage>::SetFixedImage(const ImageType * fixedImage)
{
...
template <class TImage>
void
ImageToImageRegistrationMethod<TImage>::SetMovingImage(const ImageType * movingImage)
{
...
template <class TImage>
void
ImageToImageRegistrationMethod<TImage>::SetRegionOfInterest(const PointType & point1, const PointType & point2)
{
...
template <class TImage>
void
ImageToImageRegistrationMethod<TImage>::SetFixedImageMaskObject(const MaskObjectType * maskObject)
{
...
template <class TImage>
void
ImageToImageRegistrationMethod<TImage>::SetMovingImageMaskObject(const MaskObjectType * maskObject)
{
...
ImageToImageRegistrationMethod<TImage>::GetOutput() const
{
...
template <class TImage>
DataObject::Pointer
ImageToImageRegistrationMethod<TImage>::MakeOutput(DataObjectPointerArraySizeType idx)
{
  switch (idx)
  {
    case 0:
...
template <class TImage>
ModifiedTimeType
ImageToImageRegistrationMethod<TImage>::GetMTime(void) const
{
...
template <class TImage>
void
ImageToImageRegistrationMethod<TImage>::Initialize(void)
{
...
template <class TImage>
void
ImageToImageRegistrationMethod<TImage>::GenerateData(void)
{
  this->Update();
}
...
template <class TImage>
void
ImageToImageRegistrationMethod<TImage>::PrintSelf(std::ostream & os, Indent indent) const
{
  ...
  {
    os << indent << "Moving Image Mask Object = " << this->m_MovingImageMaskObject << std::endl;
  }
  else
  {
