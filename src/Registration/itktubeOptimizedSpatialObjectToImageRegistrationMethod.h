...
#ifndef itktubeOptimizedSpatialObjectToImageRegistrationMethod_h
#define itktubeOptimizedSpatialObjectToImageRegistrationMethod_h
...
public:
  typedef OptimizedSpatialObjectToImageRegistrationMethod Self;
  using Superclass = SpatialObjectToImageRegistrationMethod<ObjectDimension, TImage>;
  using Pointer = SmartPointer<Self>;
  using ConstPointer = SmartPointer<const Self>;

  itkTypeMacro(OptimizedSpatialObjectToImageRegistrationMethod, SpatialObjectToImageRegistrationMethod);
