...
#ifndef itktubeSpatialObjectToImageRegistrationHelper_hxx
#define itktubeSpatialObjectToImageRegistrationHelper_hxx
...
SpatialObjectToImageRegistrationHelper<ObjectDimension, TImage>::SpatialObjectToImageRegistrationHelper()
{
  // Data
  m_FixedImage = NULL;
  ...
  m_RigidMetricMethodEnum = OptimizedRegistrationMethodType::IMAGE_INTENSITY_METRIC;
...
template <unsigned int ObjectDimension, class TImage>
void
SpatialObjectToImageRegistrationHelper<ObjectDimension, TImage>::SetFixedImage(const TImage * fixedImage)
{
...
template <unsigned int ObjectDimension, class TImage>
void
SpatialObjectToImageRegistrationHelper<ObjectDimension, TImage>::SetMovingSpatialObject(
...
template <unsigned int ObjectDimension, class TImage>
void
SpatialObjectToImageRegistrationHelper<ObjectDimension, TImage>::SetFixedImageMaskObject(
...
template <unsigned int ObjectDimension, class TImage>
void
SpatialObjectToImageRegistrationHelper<ObjectDimension, TImage>::SetMovingSpatialObjectMaskObject(
...
template <unsigned int ObjectDimension, class TImage>
void
SpatialObjectToImageRegistrationHelper<ObjectDimension, TImage>::SetRegistration(RegistrationMethodEnumType reg)
{
  switch (reg)
  {
    default:
...
template <unsigned int ObjectDimension, class TImage>
void
SpatialObjectToImageRegistrationHelper<ObjectDimension, TImage>::SetMetric(MetricMethodEnumType metric)
{
...
template <unsigned int ObjectDimension, class TImage>
void
SpatialObjectToImageRegistrationHelper<ObjectDimension, TImage>::Initialize(void)
{
...
template <unsigned int ObjectDimension, class TImage>
void
SpatialObjectToImageRegistrationHelper<ObjectDimension, TImage>::AffineRegND(Image<double, 2> * itkNotUsed(tmpImage))
{
...
template <unsigned int ObjectDimension, class TImage>
void
SpatialObjectToImageRegistrationHelper<ObjectDimension, TImage>::AffineRegND(Image<double, 3> * itkNotUsed(tmpImage))
{
  if (this->GetReportProgress())
  {
    std::cout << "*** AFFINE REGISTRATION ***" << std::endl;
...
template <unsigned int ObjectDimension, class TImage>
void
SpatialObjectToImageRegistrationHelper<ObjectDimension, TImage>::Update(void)
{
  ...
  if (m_EnableLoadedRegistration && m_LoadedMatrixTransform.IsNotNull())
  {
...
SpatialObjectToImageRegistrationHelper<ObjectDimension, TImage>::ResampleSpatialObject(
  const SpatialObjectType *   movingSpatialObject,
  const MatrixTransformType * matrixTransform,
  double                      portion)
{
  using ResampleFilterType = PointBasedSpatialObjectTransformFilter<MatrixTransformType, ObjectDimension>;

  if (movingSpatialObject == NULL && matrixTransform == NULL && portion == 1.0 && m_CompletedResampling)
  {
  ...
  typename SpatialObjectType::ConstPointer inputSO = m_CurrentMovingSpatialObject;
  ...
  if (doMatrix && aTrans.IsNotNull())
  {
    ...
    if (movingSpatialObject == NULL && matrixTransform == NULL && portion == 1.0)
    {
...
template <unsigned int ObjectDimension, class TImage>
const SpatialObject<ObjectDimension> *
SpatialObjectToImageRegistrationHelper<ObjectDimension, TImage>::GetFinalMovingSpatialObject(void)
{
...
template <unsigned int ObjectDimension, class TImage>
void
SpatialObjectToImageRegistrationHelper<ObjectDimension, TImage>::LoadParameters(
  const std::string & itkNotUsed(filename))
{}

template <unsigned int ObjectDimension, class TImage>
void
SpatialObjectToImageRegistrationHelper<ObjectDimension, TImage>::SaveParameters(
  const std::string & itkNotUsed(filename))
{}

template <unsigned int ObjectDimension, class TImage>
void
SpatialObjectToImageRegistrationHelper<ObjectDimension, TImage>::LoadTransform(const std::string & filename,
                                                                               bool                invert)
{
...
template <unsigned int ObjectDimension, class TImage>
void
SpatialObjectToImageRegistrationHelper<ObjectDimension, TImage>::SaveTransform(const std::string & filename)
{
...
template <unsigned int ObjectDimension, class TImage>
void
SpatialObjectToImageRegistrationHelper<ObjectDimension, TImage>::SetLoadedMatrixTransform(
  const MatrixTransformType & tfm,
  bool                        invert)
{
...
template <unsigned int ObjectDimension, class TImage>
void
SpatialObjectToImageRegistrationHelper<ObjectDimension, TImage>::SetFixedLandmarks(
  const std::vector<std::vector<float>> & fixedLandmarks)
{
...
template <unsigned int ObjectDimension, class TImage>
void
SpatialObjectToImageRegistrationHelper<ObjectDimension, TImage>::SetMovingLandmarks(
  const std::vector<std::vector<float>> & movingLandmarks)
{
...
template <unsigned int ObjectDimension, class TImage>
void
SpatialObjectToImageRegistrationHelper<ObjectDimension, TImage>::PrintSelfHelper(std::ostream &       os,
                                                                                 Indent               indent,
                                                                                 ...
                                                                                 MetricMethodEnumType metric) const
{
  switch (metric)
  {
    case OptimizedRegistrationMethodType::IMAGE_INTENSITY_METRIC:
      os << indent << basename << " Metric Method = IMAGE_INTENSITY_METRIC" << std::endl;
      break;
    default:
...
template <unsigned int ObjectDimension, class TImage>
void
SpatialObjectToImageRegistrationHelper<ObjectDimension, TImage>::PrintSelf(std::ostream & os, Indent indent) const
{
  ...
  os << indent << "Use Moving SpatialObject Mask Object = " << m_UseMovingSpatialObjectMaskObject << std::endl;
  os << indent << std::endl;
  if (m_MovingSpatialObjectMaskObject.IsNotNull())
  {
    os << indent << "Moving SpatialObject Mask Object = " << m_MovingSpatialObjectMaskObject << std::endl;
  }
  os << indent << std::endl;
  ...
  {
    os << indent << "Current Moving SpatialObject = " << m_CurrentMovingSpatialObject << std::endl;
  }
  else
  {
  ...
  if (m_LoadedTransformResampledSpatialObject.IsNotNull())
  {
    os << indent << "Loaded Transform Resampled SpatialObject = " << m_LoadedTransformResampledSpatialObject
       << std::endl;
  }
  else
  {
  ...
  {
    os << indent << "Matrix Transform Resampled SpatialObject = " << m_MatrixTransformResampledSpatialObject
       << std::endl;
  }
  else
  {
