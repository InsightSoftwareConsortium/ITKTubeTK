...
#ifndef itktubeAffineSpatialObjectToImageRegistrationMethod_h
#define itktubeAffineSpatialObjectToImageRegistrationMethod_h
...
public:
  ...
  itkOverrideGetNameOfClassMacro(AffineSpatialObjectToImageRegistrationMethod);
