...
#ifndef tubeRigidSpatialObjectToImageRegistrationMethod_hxx
#define tubeRigidSpatialObjectToImageRegistrationMethod_hxx
...
RigidSpatialObjectToImageRegistrationMethod<ObjectDimension, TImage>::RigidSpatialObjectToImageRegistrationMethod(void)
{
  if (ImageDimension == 2)
  {
...
RigidSpatialObjectToImageRegistrationMethod<ObjectDimension, TImage>::GetTypedTransform(void) const
{
...
RigidSpatialObjectToImageRegistrationMethod<ObjectDimension, TImage>::GetAffineTransform(void) const
{
...
template <unsigned int ObjectDimension, class TImage>
void
RigidSpatialObjectToImageRegistrationMethod<ObjectDimension, TImage>::SetInitialTransformParametersFromAffineTransform(
...
template <unsigned int ObjectDimension, class TImage>
void
RigidSpatialObjectToImageRegistrationMethod<ObjectDimension, TImage>::PrintSelf(std::ostream & os, Indent indent) const
{
