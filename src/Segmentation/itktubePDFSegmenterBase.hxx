...
PDFSegmenterBase<TImage, TLabelMap>::ApplyPDFs(void)
{
  ...
  {
    using ProbImageFilterType = itk::SmoothingRecursiveGaussianImageFilter<ProbabilityImageType, ProbabilityImageType>;
  ...
  if (!m_ForceClassification)
  {
    for (unsigned int c = 0; c < numClasses; c++)
    {
      ...
      using ConnectedFilterType = itk::ConnectedThresholdImageFilter<LabelMapType, LabelMapType>;
      ...
      {
        using HoleFillingFilterType = itk::VotingBinaryIterativeHoleFillingImageFilter<LabelMapType>;
      ...
      // Erode
      //
      using StructuringElementType = BinaryBallStructuringElement<LabelMapPixelType, InputImageType::ImageDimension>;
      using ErodeFilterType = BinaryErodeImageFilter<LabelMapType, LabelMapType, StructuringElementType>;
      using DilateFilterType = itk::BinaryDilateImageFilter<LabelMapType, LabelMapType, StructuringElementType>;
      ...
      {
        using ConnectedLabelMapFilterType = itk::ConnectedThresholdImageFilter<LabelMapType, LabelMapType>;
