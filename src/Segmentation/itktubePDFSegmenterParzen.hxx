...
#ifndef itktubePDFSegmenterParzen_hxx
#define itktubePDFSegmenterParzen_hxx
...
PDFSegmenterParzen<TImage, TLabelMap>::GeneratePDFs(void)
{
  ...
  if (true)
  {
    using HistogramBlurGenType = itk::DiscreteGaussianImageFilter<HistogramImageType, HistogramImageType>;
    ...
    for (unsigned int c = 0; c < numClasses; c++)
    {
      ...
      using NormalizeImageFilterType = itk::NormalizeToConstantImageFilter<HistogramImageType, HistogramImageType>;
