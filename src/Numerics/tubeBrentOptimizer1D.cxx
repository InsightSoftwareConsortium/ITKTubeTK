...
void
BrentOptimizer1D ::Use(ValueFunctionType::Pointer funcVal, DerivativeFunctionType::Pointer funcDeriv)
{
...
void
BrentOptimizer1D ::PrintSelf(std::ostream & os, Indent indent) const
{
...
void
BrentOptimizer1D ::m_Move(double & a, double & b, double & c, double d, double e, double f)
{
  a = d;
  b = e;
  c = f;
...
bool
BrentOptimizer1D ::m_Extreme(double * extX, double * extVal)
{
  unsigned int iter;
