...
#ifndef itktubeSingleValuedCostFunctionImageSource_hxx
#define itktubeSingleValuedCostFunctionImageSource_hxx
...
SingleValuedCostFunctionImageSource<TCostFunction, VNumberOfParameters>::SingleValuedCostFunctionImageSource()
...
template <class TCostFunction, unsigned int VNumberOfParameters>
void
SingleValuedCostFunctionImageSource<TCostFunction, VNumberOfParameters>::SetParametersLowerBound(
  const ParametersType & lowerBound)
{
  ...
  if (lowerBoundSize != NumberOfParameters)
  {
    itkExceptionMacro(<< "The ParametersLowerBound size: " << lowerBoundSize
                      << " does not equal the expected number of parameters: " << NumberOfParameters << std::endl);
  }
...
SingleValuedCostFunctionImageSource<TCostFunction, VNumberOfParameters>::GetParametersLowerBound() const
{
...
template <class TCostFunction, unsigned int VNumberOfParameters>
void
SingleValuedCostFunctionImageSource<TCostFunction, VNumberOfParameters>::SetParametersUpperBound(
  const ParametersType & upperBound)
{
...
template <class TCostFunction, unsigned int VNumberOfParameters>
typename SingleValuedCostFunctionImageSource<TCostFunction, VNumberOfParameters>::ParametersType
SingleValuedCostFunctionImageSource<TCostFunction, VNumberOfParameters>::GetParametersUpperBound() const
{
...
template <class TCostFunction, unsigned int VNumberOfParameters>
void
SingleValuedCostFunctionImageSource<TCostFunction, VNumberOfParameters>::SetParametersStep(const ParametersType & step)
{
...
template <class TCostFunction, unsigned int VNumberOfParameters>
typename SingleValuedCostFunctionImageSource<TCostFunction, VNumberOfParameters>::ParametersType
SingleValuedCostFunctionImageSource<TCostFunction, VNumberOfParameters>::GetParametersStep() const
{
...
template <class TCostFunction, unsigned int VNumberOfParameters>
void
SingleValuedCostFunctionImageSource<TCostFunction, VNumberOfParameters>::GenerateOutputInformation()
{
...
template <class TCostFunction, unsigned int VNumberOfParameters>
void
SingleValuedCostFunctionImageSource<TCostFunction, VNumberOfParameters>::BeforeThreadedGenerateData()
{
...
template <class TCostFunction, unsigned int VNumberOfParameters>
void
SingleValuedCostFunctionImageSource<TCostFunction, VNumberOfParameters>::ThreadedGenerateData(
