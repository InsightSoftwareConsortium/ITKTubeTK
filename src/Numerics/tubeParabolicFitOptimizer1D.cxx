...
void
ParabolicFitOptimizer1D ::Use(ValueFunctionType::Pointer funcVal)
{
...
double
ParabolicFitOptimizer1D ::m_Center(double x1, double y1, double x2, double y2, double x3, double y3)
{
...
bool
ParabolicFitOptimizer1D ::m_Extreme(double * extX, double * extVal)
{
  double minSign = 1;
  if (!m_SearchForMin)
  {
