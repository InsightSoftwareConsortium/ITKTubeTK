...
#ifndef itktubeBasisFeatureVectorGenerator_hxx
#define itktubeBasisFeatureVectorGenerator_hxx
...
BasisFeatureVectorGenerator<TImage, TLabelMap>::BasisFeatureVectorGenerator(void)
{
  m_LabelMap = nullptr;
...
template <class TImage, class TLabelMap>
void
BasisFeatureVectorGenerator<TImage, TLabelMap>::SetInputFeatureVectorGenerator(FeatureVectorGeneratorType * fGen)
{
...
BasisFeatureVectorGenerator<TImage, TLabelMap>::GetInputFeatureVectorGenerator(void)
{
...
template <class TImage, class TLabelMap>
void
BasisFeatureVectorGenerator<TImage, TLabelMap>::SetObjectId(ObjectIdType objectId)
{
  m_ObjectIdList.clear();
...
template <class TImage, class TLabelMap>
void
BasisFeatureVectorGenerator<TImage, TLabelMap>::AddObjectId(ObjectIdType objectId)
{
  m_ObjectIdList.push_back(objectId);
}
...
BasisFeatureVectorGenerator<TImage, TLabelMap>::GetObjectId(unsigned int num) const
{
...
template <class TImage, class TLabelMap>
unsigned int
BasisFeatureVectorGenerator<TImage, TLabelMap>::GetNumberOfObjectIds(void) const
{
...
BasisFeatureVectorGenerator<TImage, TLabelMap>::GetObjectMean(ObjectIdType num) const
{
  if (num < m_ObjectIdList.size())
  {
...
template <class TImage, class TLabelMap>
void
BasisFeatureVectorGenerator<TImage, TLabelMap>::SetObjectMean(ObjectIdType num, ValueType val)
{
  if (num < m_ObjectIdList.size())
  {
...
BasisFeatureVectorGenerator<TImage, TLabelMap>::GetObjectCovariance(ObjectIdType num) const
{
  if (num < m_ObjectIdList.size())
  {
...
template <class TImage, class TLabelMap>
void
BasisFeatureVectorGenerator<TImage, TLabelMap>::SetObjectCovariance(ObjectIdType num, MatrixType val)
{
  if (num < m_ObjectIdList.size())
  {
...
template <class TImage, class TLabelMap>
typename BasisFeatureVectorGenerator<TImage, TLabelMap>::ValueType
BasisFeatureVectorGenerator<TImage, TLabelMap>::GetGlobalMean(void) const
{
  return m_GlobalMean;
}
...
template <class TImage, class TLabelMap>
void
BasisFeatureVectorGenerator<TImage, TLabelMap>::SetGlobalMean(ValueType val)
{
  m_GlobalMean = val;
}
...
template <class TImage, class TLabelMap>
typename BasisFeatureVectorGenerator<TImage, TLabelMap>::MatrixType
BasisFeatureVectorGenerator<TImage, TLabelMap>::GetGlobalCovariance(void) const
{
...
template <class TImage, class TLabelMap>
void
BasisFeatureVectorGenerator<TImage, TLabelMap>::SetGlobalCovariance(MatrixType val)
{
...
BasisFeatureVectorGenerator<TImage, TLabelMap>::GetBasisVector(unsigned int basisNum) const
{
...
template <class TImage, class TLabelMap>
double
BasisFeatureVectorGenerator<TImage, TLabelMap>::GetBasisValue(unsigned int basisNum) const
{
  if (basisNum < m_InputFeatureVectorGenerator->GetNumberOfFeatures())
  {
...
template <class TImage, class TLabelMap>
typename BasisFeatureVectorGenerator<TImage, TLabelMap>::MatrixType
BasisFeatureVectorGenerator<TImage, TLabelMap>::GetBasisMatrix(void) const
{
...
template <class TImage, class TLabelMap>
typename BasisFeatureVectorGenerator<TImage, TLabelMap>::VectorType
BasisFeatureVectorGenerator<TImage, TLabelMap>::GetBasisValues(void) const
{
...
template <class TImage, class TLabelMap>
void
BasisFeatureVectorGenerator<TImage, TLabelMap>::SetBasisValue(unsigned int basisNum, double value)
{
  if (basisNum < m_InputFeatureVectorGenerator->GetNumberOfFeatures())
  {
...
template <class TImage, class TLabelMap>
void
BasisFeatureVectorGenerator<TImage, TLabelMap>::SetBasisMatrix(const MatrixType & mat)
{
  m_BasisMatrix = mat;
}
...
template <class TImage, class TLabelMap>
void
BasisFeatureVectorGenerator<TImage, TLabelMap>::SetBasisVector(unsigned int basisNum, const VectorType & vec)
{
  if (basisNum < m_InputFeatureVectorGenerator->GetNumberOfFeatures())
  {
...
template <class TImage, class TLabelMap>
void
BasisFeatureVectorGenerator<TImage, TLabelMap>::SetBasisValues(const VectorType & values)
{
...
BasisFeatureVectorGenerator<TImage, TLabelMap>::GetFeatureImage(unsigned int featureNum) const
{
  if (featureNum < m_InputFeatureVectorGenerator->GetNumberOfFeatures())
  {
    ...
    ImageIteratorType itBasisIm(featureImage, featureImage->GetLargestPossibleRegion());
    ...
    if (m_LabelMap.IsNotNull())
    {
      ...
      ConstLabelMapIteratorType itInMask(m_LabelMap, m_LabelMap->GetLargestPossibleRegion());
      bool                      found = false;
      ObjectIdType              previousMaskValue = static_cast<ObjectIdType>(itInMask.Get()) + 1;
...
template <class TImage, class TLabelMap>
void
BasisFeatureVectorGenerator<TImage, TLabelMap>::SetInputWhitenMeans(const ValueListType & means)
{
...
BasisFeatureVectorGenerator<TImage, TLabelMap>::GetInputWhitenMeans(void) const
{
...
template <class TImage, class TLabelMap>
void
BasisFeatureVectorGenerator<TImage, TLabelMap>::SetInputWhitenStdDevs(const ValueListType & stdDevs)
{
...
template <class TImage, class TLabelMap>
const typename BasisFeatureVectorGenerator<TImage, TLabelMap>::ValueListType &
BasisFeatureVectorGenerator<TImage, TLabelMap>::GetInputWhitenStdDevs(void) const
{
...
template <class TImage, class TLabelMap>
void
BasisFeatureVectorGenerator<TImage, TLabelMap>::SetOutputWhitenMeans(const ValueListType & means)
{
...
template <class TImage, class TLabelMap>
const typename BasisFeatureVectorGenerator<TImage, TLabelMap>::ValueListType &
BasisFeatureVectorGenerator<TImage, TLabelMap>::GetOutputWhitenMeans(void) const
{
...
template <class TImage, class TLabelMap>
void
BasisFeatureVectorGenerator<TImage, TLabelMap>::SetOutputWhitenStdDevs(const ValueListType & stdDevs)
{
...
template <class TImage, class TLabelMap>
const typename BasisFeatureVectorGenerator<TImage, TLabelMap>::ValueListType &
BasisFeatureVectorGenerator<TImage, TLabelMap>::GetOutputWhitenStdDevs(void) const
{
...
template <class TImage, class TLabelMap>
void
BasisFeatureVectorGenerator<TImage, TLabelMap>::Update(void)
{
  using ConstLabelMapIteratorType = itk::ImageRegionConstIteratorWithIndex<LabelMapType>;
  ConstLabelMapIteratorType itInMask(m_LabelMap, m_LabelMap->GetLargestPossibleRegion());

  const unsigned int numClasses = this->GetNumberOfObjectIds();
  const unsigned int numInputFeatures = m_InputFeatureVectorGenerator->GetNumberOfFeatures();

  if (numClasses == 0)
  {
    std::cerr << "# of classes ( object ids ) = 0.  Cannot compute basis." << std::endl;
    return;
  }

  if (m_NumberOfLDABasisToUseAsFeatures > numClasses - 1)
  {
    std::cerr << "ERROR: Number of LDA basis > ( number of classes - 1 )." << std::endl;
  ...
  while (!itInMask.IsAtEnd())
  {
    ...
    if (found)
    {
      ...
      FeatureVectorType v = m_InputFeatureVectorGenerator->GetFeatureVector(indx);
      ...
      for (unsigned int i = 0; i < numInputFeatures; i++)
      {
        ...
        objectDelta[valC][i] = (v[i] - m_ObjectMeanList[valC][i]) / (countList[valC] + 1);
      ...
      for (unsigned int i = 0; i < numInputFeatures; i++)
      {
        ...
        {
          m_GlobalCovariance[i][j] += globalCount * delta[i] * delta[j] - m_GlobalCovariance[i][j] / (globalCount + 1);
          m_GlobalCovariance[j][i] = m_GlobalCovariance[i][j];

          m_ObjectCovarianceList[valC][i][j] += countList[valC] * objectDelta[valC][i] * objectDelta[valC][j] -
                                                m_ObjectCovarianceList[valC][i][j] / (countList[valC] + 1);
          m_ObjectCovarianceList[valC][j][i] = m_ObjectCovarianceList[valC][i][j];
        }
      }
      ++globalCount;
      ++countList[valC];
  ...
  for (unsigned int i = 0; i < numInputFeatures; i++)
  {
    for (unsigned int j = i; j < numInputFeatures; j++)
    {
      if (globalCount > 1)
      {
        m_GlobalCovariance[i][j] = (globalCount / (globalCount - 1)) * m_GlobalCovariance[i][j];
      }
      else
      {
        if (i != j)
      ...
      for (unsigned int c = 0; c < numClasses; c++)
      {
        if (countList[c] > 1)
        {
          m_ObjectCovarianceList[c][i][j] = (countList[c] / (countList[c] - 1)) * m_ObjectCovarianceList[c][i][j];
        }
        else
        {
          if (i != j)
  ...
  {
    std::cerr << "ERROR: Number of input features < number of basis." << std::endl;
    std::cerr << "   Reducing number of PCA basis." << std::endl;
    int tmpNumFeatures = static_cast<int>(numInputFeatures) - m_NumberOfLDABasisToUseAsFeatures;
    if (tmpNumFeatures < 0)
    {
  ...
  if (m_NumberOfLDABasisToUseAsFeatures > 0)
  {
      ...
      for (unsigned int i = 0; i < numInputFeatures; i++)
      {
        for (unsigned int j = i; j < numInputFeatures; j++)
        {
          ...
          covarianceOfMeans[i][j] +=
            (m_ObjectMeanList[c][i] - meanOfMeans[i]) * (m_ObjectMeanList[c][j] - meanOfMeans[j]);
    ...
    ::tube::ComputeEigenOfMatrixInvertedTimesMatrix(
      meanCovariance, covarianceOfMeans, ldaBasisMatrix, ldaBasisValues, false, false);
    ...
    ::tube::ComputeEigenOfMatrixInvertedTimesMatrix(
      biasMatrix, m_GlobalCovariance, pcaBasisMatrix, pcaBasisValues, false, false);
  }
  else
  {
    ::tube::ComputeEigen<double>(m_GlobalCovariance, pcaBasisMatrix, pcaBasisValues, false, false);
  }

  for (unsigned int f = 0; f < numInputFeatures - m_NumberOfLDABasisToUseAsFeatures; ++f)
  {
...
template <class TImage, class TLabelMap>
void
BasisFeatureVectorGenerator<TImage, TLabelMap>::UpdateWhitenStatistics(void)
{
...
template <class TImage, class TLabelMap>
void
BasisFeatureVectorGenerator<TImage, TLabelMap>::SetNumberOfLDABasisToUseAsFeatures(unsigned int numBasisUsed)
{
...
template <class TImage, class TLabelMap>
void
BasisFeatureVectorGenerator<TImage, TLabelMap>::SetNumberOfPCABasisToUseAsFeatures(unsigned int numBasisUsed)
{
...
template <class TImage, class TLabelMap>
unsigned int
BasisFeatureVectorGenerator<TImage, TLabelMap>::GetNumberOfFeatures(void) const
{
  return m_NumberOfPCABasisToUseAsFeatures + m_NumberOfLDABasisToUseAsFeatures;
}

template <class TImage, class TLabelMap>
unsigned int
BasisFeatureVectorGenerator<TImage, TLabelMap>::GetNumberOfPCABasisToUseAsFeatures(void) const
{
...
template <class TImage, class TLabelMap>
unsigned int
BasisFeatureVectorGenerator<TImage, TLabelMap>::GetNumberOfLDABasisToUseAsFeatures(void) const
{
...
BasisFeatureVectorGenerator<TImage, TLabelMap>::GetFeatureVector(const IndexType & indx) const
{
  const unsigned int numInputFeatures = m_InputFeatureVectorGenerator->GetNumberOfFeatures();
...
BasisFeatureVectorGenerator<TImage, TLabelMap>::GetFeatureVectorValue(const IndexType & indx,
                                                                      unsigned int      featureNum) const
{
  ...
  if (featureNum < this->GetNumberOfFeatures())
  {
    ...
    {
      featureValue = (featureValue - this->GetWhitenMean(featureNum)) / this->GetWhitenStdDev(featureNum);
    }
    return featureValue;
  }
  else
  {
    std::cerr << "Basis feature " << featureNum << " does not exist." << std::endl;
    FeatureValueType featureValue = 0;
    return featureValue;
  }
}
...
template <class TImage, class TLabelMap>
void
BasisFeatureVectorGenerator<TImage, TLabelMap>::PrintSelf(std::ostream & os, Indent indent) const
{
  ...
  os << indent << "ObjectIdList.size = " << m_ObjectIdList.size() << std::endl;
  os << indent << "ObjectMeanList.size = " << m_ObjectMeanList.size() << std::endl;
  os << indent << "ObjectCovarianceList.size = " << m_ObjectCovarianceList.size() << std::endl;
  ...
  os << indent << "NumberOfPCABasisToUseAsFeatures = " << m_NumberOfPCABasisToUseAsFeatures << std::endl;
  os << indent << "NumberOfLDABasisToUseAsFeatures = " << m_NumberOfLDABasisToUseAsFeatures << std::endl;
}
