...
#ifndef itktubeVectorImageToListGenerator_hxx
#define itktubeVectorImageToListGenerator_hxx
...
VectorImageToListGenerator<TImage, TMaskImage>::VectorImageToListGenerator(void)
{
...
template <class TImage, class TMaskImage>
void
VectorImageToListGenerator<TImage, TMaskImage>::PrintSelf(std::ostream & os, Indent indent) const
{
...
template <class TImage, class TMaskImage>
void
VectorImageToListGenerator<TImage, TMaskImage>::SetInput(const ImageType * image)
{
...
template <class TImage, class TMaskImage>
void
VectorImageToListGenerator<TImage, TMaskImage>::SetMaskImage(const MaskImageType * image)
{
  // Process object is not const-correct so the const_cast is required here
...
template <class TImage, class TMaskImage>
void
VectorImageToListGenerator<TImage, TMaskImage>::SetMaskValue(const MaskPixelType maskValue)
{
...
template <class TImage, class TMaskImage>
const TImage *
VectorImageToListGenerator<TImage, TMaskImage>::GetInput(void) const
{
...
template <class TImage, class TMaskImage>
const TMaskImage *
VectorImageToListGenerator<TImage, TMaskImage>::GetMaskImage(void) const
{
...
VectorImageToListGenerator<TImage, TMaskImage>::MakeOutput(DataObjectPointerArraySizeType itkNotUsed(idx))
{
...
template <class TImage, class TMaskImage>
void
VectorImageToListGenerator<TImage, TMaskImage>::GenerateData(void)
{
...
template <class TImage, class TMaskImage>
void
VectorImageToListGenerator<TImage, TMaskImage>::GenerateOutputInformation(void)
{
...
template <class TImage, class TMaskImage>
void
VectorImageToListGenerator<TImage, TMaskImage>::GenerateInputRequestedRegion()
{
...
VectorImageToListGenerator<TImage, TMaskImage>::GetListSample(void) const
{
  const ListSampleOutputType * decoratedOutput =
    static_cast<const ListSampleOutputType *>(this->ProcessObject::GetOutput(0));
