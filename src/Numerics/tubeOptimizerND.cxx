...
OptimizerND ::OptimizerND(unsigned int                    dimension,
...
void
OptimizerND ::Use(unsigned int                    dimension,
                  ValueFunctionType::Pointer      funcValND,
                  DerivativeFunctionType::Pointer funcDerivND,
                  Optimizer1D::Pointer            optimizer1D)
{
...
void
OptimizerND ::SetTolerance(double tolerance)
{
  if (m_Optimizer1D != NULL)
  {
...
void
OptimizerND ::SetMaxIterations(unsigned int maxIterations)
{
  if (m_Optimizer1D != NULL)
  {
...
void
OptimizerND ::SetSearchForMin(bool searchForMin)
{
  if (m_Optimizer1D != NULL)
  {
...
double
OptimizerND ::FuncDeriv(double a)
{
  m_X0Temp = ComputeLineStep(m_X0, a, m_X0Dir);
...
bool
OptimizerND ::Extreme(VectorType & x, double * xVal)
{
  m_X0 = x;
  double a = 1;
...
bool
OptimizerND ::Extreme(VectorType & x, double * xVal, unsigned int n, MatrixType & directions)
{
  m_X0 = x;
  double a;
  double xmin;
...
void
OptimizerND ::PrintSelf(std::ostream & os, Indent indent) const
{
