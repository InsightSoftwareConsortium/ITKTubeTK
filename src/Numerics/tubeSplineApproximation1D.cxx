...
double
SplineApproximation1D ::DataValue(const VectorType & y, double x)
{
  double u[4];
  u[3] = 1.0;
  u[2] = x - (int)x;
...
double
SplineApproximation1D ::DataValueD(const VectorType & y, double x)
{
  double u[3];
  u[2] = 1.0;
  u[1] = x - (int)x;
...
double
SplineApproximation1D ::DataValueD2(const VectorType & y, double x)
{
  double u[2];
  u[1] = 1.0;
  u[0] = x - (int)x;
...
double
SplineApproximation1D ::DataValueJet(const VectorType & y, double x, double * d, double * d2)
{
...
void
SplineApproximation1D ::PrintSelf(std::ostream & os, Indent indent) const
{
