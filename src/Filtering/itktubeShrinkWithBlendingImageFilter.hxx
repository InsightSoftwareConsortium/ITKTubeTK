...
=========================================================================*/
#ifndef itktubeShrinkWithBlendingImageFilter_hxx
#define itktubeShrinkWithBlendingImageFilter_hxx
  ...
  ThreadIdType                  threadId)
{
  ...
  using PointImageConstIteratorType = ImageRegionConstIteratorWithIndex<PointImageType>;
  ...
  using PointImageIteratorType = ImageRegionIteratorWithIndex<PointImageType>;
