...
=========================================================================*/
#ifndef itktubeFFTGaussianDerivativeIFFTFilter_hxx
#define itktubeFFTGaussianDerivativeIFFTFilter_hxx
...
FFTGaussianDerivativeIFFTFilter<TInputImage, TOutputImage>::FFTGaussianDerivativeIFFTFilter()
{
...
template <typename TInputImage, typename TOutputImage>
void
FFTGaussianDerivativeIFFTFilter<TInputImage, TOutputImage>::ComputeInputImageFFT()
{
...
template <typename TInputImage, typename TOutputImage>
void
FFTGaussianDerivativeIFFTFilter<TInputImage, TOutputImage>::ComputeKernelImageFFT()
{
  typename GaussianDerivativeImageSourceType::Pointer gaussSource = GaussianDerivativeImageSourceType::New();

  const typename ComplexImageType::RegionType inputRegion(this->GetInput()->GetLargestPossibleRegion());
  const typename ComplexImageType::SizeType   inputSize = inputRegion.GetSize();

  const typename ComplexImageType::RegionType    fftRegion(m_InputImageFFT->GetLargestPossibleRegion());
  const typename ComplexImageType::SizeType      fftSize = fftRegion.GetSize();
  const typename ComplexImageType::SpacingType   fftSpacing = m_InputImageFFT->GetSpacing();
  const typename ComplexImageType::PointType     fftOrigin = m_InputImageFFT->GetOrigin();
  const typename ComplexImageType::DirectionType fftDirection = m_InputImageFFT->GetDirection();
...
template <typename TInputImage, typename TOutputImage>
void
FFTGaussianDerivativeIFFTFilter<TInputImage, TOutputImage>::ComputeConvolvedImageFFT()
{
...
template <typename TInputImage, typename TOutputImage>
void
FFTGaussianDerivativeIFFTFilter<TInputImage, TOutputImage>::ComputeConvolvedImage()
{
  ...
  typename RegionFromFilterType::Pointer regionFrom = RegionFromFilterType::New();
...
template <typename TInputImage, typename TOutputImage>
void
FFTGaussianDerivativeIFFTFilter<TInputImage, TOutputImage>::GenerateData()
{
...
template <typename TInputImage, typename TOutputImage>
void
FFTGaussianDerivativeIFFTFilter<TInputImage, TOutputImage>::GenerateNJet(
  typename TOutputImage::Pointer &              D,
  ...
  std::vector<typename TOutputImage::Pointer> & dXX)
{
  ...
  std::vector<typename ComplexImageType::Pointer> dXKernelImageFFT(ImageDimension);
...
template <typename TInputImage, typename TOutputImage>
void
FFTGaussianDerivativeIFFTFilter<TInputImage, TOutputImage>::PrintSelf(std::ostream & os, Indent indent) const
{
