  ...
  typename SpatialObjectType::TransformType::ConstPointer & outputTransform)
{
  ...
  using DisplacementFieldTransformFilterType =
    itk::tube::PointBasedSpatialObjectTransformFilter<DisplacementFieldTransformType, ObjectDimension>;
  ...
  typename SpatialObjectType::TransformType::ConstPointer & outputTransform)
{
  ...
  using MatrixOffsetTransformFilterType =
    itk::tube::PointBasedSpatialObjectTransformFilter<MatrixOffsetTransformType, ObjectDimension>;
  ...
  typename SpatialObjectType::TransformType::ConstPointer & outputTransform)
{
  ...
  using AffineTransformFilterType =
    itk::tube::PointBasedSpatialObjectTransformFilter<AffineTransformType, ObjectDimension>;
