...
#ifndef itktubeContrastCostFunction_hxx
#define itktubeContrastCostFunction_hxx
...
ContrastCostFunction< TPixel, Dimension >
...
void
ContrastCostFunction< TPixel, Dimension >
::SetScales( ParametersType & scales )
{
  m_Scales = scales;
}
...
double
ContrastCostFunction< TPixel, Dimension >
::GetValue( const ParametersType & params ) const
{
...
void
ContrastCostFunction< TPixel, Dimension >
::GetDerivative( const ParametersType & params,
