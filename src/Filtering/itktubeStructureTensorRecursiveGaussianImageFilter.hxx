...
#ifndef itktubeStructureTensorRecursiveGaussianImageFilter_hxx
#define itktubeStructureTensorRecursiveGaussianImageFilter_hxx
...
StructureTensorRecursiveGaussianImageFilter<TInputImage, TOutputImage>::StructureTensorRecursiveGaussianImageFilter(
  void)
{
  ...
  m_TensorComponentSmoothingFilter->SetOrder(GaussianOrderEnum::ZeroOrder);
...
template <class TInputImage, class TOutputImage>
void
StructureTensorRecursiveGaussianImageFilter<TInputImage, TOutputImage>::SetSigma(RealType sigma)
{
...
template <class TInputImage, class TOutputImage>
void
StructureTensorRecursiveGaussianImageFilter<TInputImage, TOutputImage>::SetSigmaOuter(RealType sigma)
{
  m_SigmaOuter = sigma;
...
template <class TInputImage, class TOutputImage>
void
StructureTensorRecursiveGaussianImageFilter<TInputImage, TOutputImage>::SetNormalizeAcrossScale(bool normalize)
{
...
template <class TInputImage, class TOutputImage>
void
StructureTensorRecursiveGaussianImageFilter<TInputImage, TOutputImage>::GenerateInputRequestedRegion()
{
  ...
  typename StructureTensorRecursiveGaussianImageFilter<TInputImage, TOutputImage>::InputImagePointer image =
...
template <class TInputImage, class TOutputImage>
void
StructureTensorRecursiveGaussianImageFilter<TInputImage, TOutputImage>::EnlargeOutputRequestedRegion(
  DataObject * output)
{
...
template <class TInputImage, class TOutputImage>
void
StructureTensorRecursiveGaussianImageFilter<TInputImage, TOutputImage>::GenerateData(void)
{
  ...
  ImageRegionIteratorWithIndex<OutputImageType> ottensor(this->GetOutput(), this->GetOutput()->GetRequestedRegion());

  ImageRegionIteratorWithIndex<OutputImageType> itgradient(this->GetOutput(), this->GetOutput()->GetRequestedRegion());
  ...
  for (unsigned int i = 0; i < numberTensorElements; i++)
  {
    ...
    ImageRegionIteratorWithIndex<ComponentImageType> compit(componentImage, componentImage->GetRequestedRegion());
    ...
    ImageRegionIteratorWithIndex<ComponentImageType> smoothedCompIt(
      m_TensorComponentSmoothingFilter->GetOutput(),
...
template <class TInputImage, class TOutputImage>
void
StructureTensorRecursiveGaussianImageFilter<TInputImage, TOutputImage>::PrintSelf(std::ostream & os,
                                                                                  Indent         indent) const
{
