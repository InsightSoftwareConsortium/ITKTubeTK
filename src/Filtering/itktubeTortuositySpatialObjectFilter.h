...
#ifndef itktubeTortuositySpatialObjectFilter_h
#define itktubeTortuositySpatialObjectFilter_h
...
class TortuositySpatialObjectFilter : public SpatialObjectToSpatialObjectFilter<TTubeSpatialObject, TTubeSpatialObject>
{
public:
  /** Standard class type alias. */
  using Self = TortuositySpatialObjectFilter;
  using Superclass = SpatialObjectToSpatialObjectFilter<TTubeSpatialObject, TTubeSpatialObject>;
   ...
   */
  itkSetClampMacro(NumberOfBins, size_t, 1, std::numeric_limits<size_t>::max());
   ...
   */
  itkSetClampMacro(SubsamplingScale, int, 0, std::numeric_limits<int>::max());
