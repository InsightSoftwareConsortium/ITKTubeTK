...
PadImageFilter<TInputImage, TOutputImage>::GenerateData()
{
  ...
  using PadType = typename itk::PadImageFilter<InputImageType, OutputImageType>;
  using ConstantPadType = typename itk::ConstantPadImageFilter<InputImageType, OutputImageType>;
  using ZeroFluxPadType = typename itk::ZeroFluxNeumannPadImageFilter<InputImageType, OutputImageType>;
  using MirrorPadType = typename itk::MirrorPadImageFilter<InputImageType, OutputImageType>;
  using WrapPadType = typename itk::WrapPadImageFilter<InputImageType, OutputImageType>;
  SizeType s;
