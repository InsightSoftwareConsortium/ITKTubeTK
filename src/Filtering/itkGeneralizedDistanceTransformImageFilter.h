...
template <class TFunctionImage, class TDistanceImage = TFunctionImage, class TLabelImage = TFunctionImage>
class GeneralizedDistanceTransformImageFilter : public ImageToImageFilter<TFunctionImage, TDistanceImage>
{
public:
...
private:
  ...
  intersection(const Parabola & p, const Parabola & q, const AbscissaIndexType & from, const AbscissaIndexType & to);
  ...
  inline void
  addParabola(Parabolas &                      envelope,
              const AbscissaIndexType &        to,
  ...
  inline bool
  sampleValues(const Parabolas &         envelope,
               const AbscissaIndexType & from,
               const long &              steps,
  ...
  inline bool
  sampleVoronoi(const Parabolas &         envelope,
                const AbscissaIndexType & from,
                const long &              steps,
