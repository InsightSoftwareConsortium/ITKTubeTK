 ...
 *
 *=========================================================================*/
#ifndef itktubeLimitedMinimumMaximumImageFilter_h
#define itktubeLimitedMinimumMaximumImageFilter_h
...
namespace tube
{
/** \class LimitedMinimumMaximumImageFilter
...
class ITK_TEMPLATE_EXPORT LimitedMinimumMaximumImageFilter : public ImageSink<TInputImage>
{
public:
  ITK_DISALLOW_COPY_AND_MOVE(LimitedMinimumMaximumImageFilter);
...
protected:
  LimitedMinimumMaximumImageFilter();
  ~LimitedMinimumMaximumImageFilter() override = default;
  void
...
#  include "itktubeLimitedMinimumMaximumImageFilter.hxx"
#endif
