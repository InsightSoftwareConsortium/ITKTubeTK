 ...
 *
 *=========================================================================*/
#ifndef itktubeGaussianDerivativeFilter_h
#define itktubeGaussianDerivativeFilter_h
...
class GaussianDerivativeFilter : public ImageToImageFilter<TInputImage, TOutputImage>
{
public:
  ...
  typedef typename GaussianDerivativeImageSourceType::OrdersType OrdersType;
  typedef typename GaussianDerivativeImageSourceType::SigmasType SigmasType;
