...
#ifndef itktubeEnhanceContrastUsingPriorImageFilter_hxx
#define itktubeEnhanceContrastUsingPriorImageFilter_hxx
...
EnhanceContrastUsingPriorImageFilter<TPixel, VDimension>::EnhanceContrastUsingPriorImageFilter(void)
{
...
template <class TPixel, unsigned int VDimension>
void
EnhanceContrastUsingPriorImageFilter<TPixel, VDimension>::PrintSelf(std::ostream & os, Indent indent) const
{
...
template <class TPixel, unsigned int VDimension>
void
EnhanceContrastUsingPriorImageFilter<TPixel, VDimension>::GenerateData(void)
{
  ...
  itk::ImageRegionConstIterator<ImageType> iter(inputImage, inputImage->GetLargestPossibleRegion());
  ...
  typename ContrastCostFunctionType::Pointer costFunc = ContrastCostFunctionType::New();
  ...
  typename itk::Statistics::NormalVariateGenerator::Pointer normGen = itk::Statistics::NormalVariateGenerator::New();
  ...
  std::cout << "Intermediate params = " << params << " Result = " << result << std::endl;
  ...
  std::cout << "Winning params = " << params << " Result = " << result << std::endl;
}
