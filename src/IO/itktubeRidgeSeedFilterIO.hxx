...
=========================================================================*/
#ifndef itktubeRidgeSeedFilterIO_hxx
#define itktubeRidgeSeedFilterIO_hxx
...
RidgeSeedFilterIO<TImage, TLabelMap>::RidgeSeedFilterIO(void)
{
  Clear();
}

template <class TImage, class TLabelMap>
RidgeSeedFilterIO<TImage, TLabelMap>::RidgeSeedFilterIO(const char * _headerName)
{
  Clear();
...
template <class TImage, class TLabelMap>
RidgeSeedFilterIO<TImage, TLabelMap>::RidgeSeedFilterIO(const typename RidgeSeedFilterType::Pointer & _filter)
{
  Clear();
...
template <class TImage, class TLabelMap>
RidgeSeedFilterIO<TImage, TLabelMap>::~RidgeSeedFilterIO()
{}

template <class TImage, class TLabelMap>
void
RidgeSeedFilterIO<TImage, TLabelMap>::PrintInfo() const
{
...
template <class TImage, class TLabelMap>
void
RidgeSeedFilterIO<TImage, TLabelMap>::CopyInfo(const RidgeSeedFilterIOType & _filterIO)
{
  Clear();
...
template <class TImage, class TLabelMap>
void
RidgeSeedFilterIO<TImage, TLabelMap>::Clear(void)
{
...
template <class TImage, class TLabelMap>
bool
RidgeSeedFilterIO<TImage, TLabelMap>::InitializeEssential(const typename RidgeSeedFilterType::Pointer & _filter)
{
...
template <class TImage, class TLabelMap>
void
RidgeSeedFilterIO<TImage, TLabelMap>::SetRidgeSeedFilter(const typename RidgeSeedFilterType::Pointer & _filter)
{
  m_RidgeSeedFilter = _filter;
}
...
RidgeSeedFilterIO<TImage, TLabelMap>::GetRidgeSeedFilter(void) const
{
...
template <class TImage, class TLabelMap>
bool
RidgeSeedFilterIO<TImage, TLabelMap>::CanRead(const char * _headerName) const
{
...
template <class TImage, class TLabelMap>
bool
RidgeSeedFilterIO<TImage, TLabelMap>::Read(const char * _headerName)
{
  ...
  m_RidgeSeedFilter->SetUseFeatureMath(seedReader.GetUseFeatureMath());
  ...
  m_RidgeSeedFilter->SetInputWhitenMeans(seedReader.GetInputWhitenMeans());
  m_RidgeSeedFilter->SetInputWhitenStdDevs(seedReader.GetInputWhitenStdDevs());
  m_RidgeSeedFilter->SetOutputWhitenMeans(seedReader.GetOutputWhitenMeans());
  m_RidgeSeedFilter->SetOutputWhitenStdDevs(seedReader.GetOutputWhitenStdDevs());
  ...
  typename PDFSegmenterParzenType::Pointer pdfParzen =
    dynamic_cast<PDFSegmenterParzenType *>(m_RidgeSeedFilter->GetPDFSegmenter().GetPointer());
  if (pdfParzen.IsNotNull())
  {
    PDFSegmenterParzenIO<TImage, TLabelMap> pdfReader(pdfParzen.GetPointer());
    if (!pdfReader.Read(pdfFileName.c_str()))
    {
      std::cerr << "Cannot read Parzen file: " << pdfFileName << std::endl;
      m_RidgeSeedFilter = NULL;
      return false;
    }
  }
...
template <class TImage, class TLabelMap>
bool
RidgeSeedFilterIO<TImage, TLabelMap>::Write(const char * _headerName)
{
  if (m_RidgeSeedFilter.IsNull())
  {
    return false;
  ...
  seedWriter.SetUseFeatureMath(m_RidgeSeedFilter->GetUseFeatureMath());
  ...
  seedWriter.SetInputWhitenMeans(m_RidgeSeedFilter->GetInputWhitenMeans());
  seedWriter.SetInputWhitenStdDevs(m_RidgeSeedFilter->GetInputWhitenStdDevs());
  seedWriter.SetOutputWhitenMeans(m_RidgeSeedFilter->GetOutputWhitenMeans());
  seedWriter.SetOutputWhitenStdDevs(m_RidgeSeedFilter->GetOutputWhitenStdDevs());
  ...
  if (pdfParzen.IsNotNull())
  {
    PDFSegmenterParzenIO<TImage, TLabelMap> pdfWriter(pdfParzen.GetPointer());
