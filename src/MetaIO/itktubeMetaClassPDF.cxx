...
MetaClassPDF::MetaClassPDF(void)
{
  if (META_DEBUG)
  {
...
MetaClassPDF::MetaClassPDF(const char * _headerName)
{
  if (META_DEBUG)
  {
    std::cout << "MetaClassPDF()" << std::endl;
...
MetaClassPDF::MetaClassPDF(const MetaClassPDF & _metaPDF)
  : MetaImage()
{
  if (META_DEBUG)
  {
...
MetaClassPDF::MetaClassPDF(unsigned int             _nFeatures,
                           ...
                           float *                  _elementData)
{
  ...
  MetaClassPDF::InitializeEssential(_nFeatures, _nBinsPerFeature, _binMin, _binSize, _elementData);
}

MetaClassPDF::MetaClassPDF(unsigned int _x,
                           unsigned int _y,
                           double       _binMinX,
                           double       _binMinY,
                           double       _binSizeX,
...
MetaClassPDF::~MetaClassPDF() {}

void
MetaClassPDF::PrintInfo(void) const
{
  MetaImage::PrintInfo();
  ...
  std::cout << "ProbabilityImageSmoothingStandardDeviation : " << m_ProbabilityImageSmoothingStandardDeviation
            << std::endl;
  std::cout << "HistogramSmoothingStandardDeviation : " << m_HistogramSmoothingStandardDeviation << std::endl;
  std::cout << "OutlierRejectPortion : " << m_OutlierRejectPortion << std::endl;
  if (m_Draft)
  {
...
void
MetaClassPDF::CopyInfo(const MetaObject * _obj)
{
  MetaClassPDF::Clear();
  ...
  if (tmpPDF)
  {
    MetaClassPDF::InitializeEssential(tmpPDF->GetNumberOfFeatures(),
                                      tmpPDF->GetNumberOfBinsPerFeature(),
                                      tmpPDF->GetBinMin(),
                                      tmpPDF->GetBinSize(),
                                      NULL);
    ...
    this->SetProbabilityImageSmoothingStandardDeviation(tmpPDF->GetProbabilityImageSmoothingStandardDeviation());
    this->SetHistogramSmoothingStandardDeviation(tmpPDF->GetHistogramSmoothingStandardDeviation());
    ...
    this->SetReclassifyNotObjectLabels(tmpPDF->GetReclassifyNotObjectLabels());
    this->SetForceClassification(tmpPDF->GetForceClassification());
  }
}

void
MetaClassPDF::Clear(void)
{
  if (META_DEBUG)
  {
...
bool
MetaClassPDF::InitializeEssential(unsigned int             _nFeatures,
                                  const VectorUIntType &   _nBinsPerFeature,
                                  const VectorDoubleType & _binMin,
                                  const VectorDoubleType & _binSize,
                                  float *                  _elementData)
{
  ...
  MetaImage::InitializeEssential(_nFeatures, nBins, binSize, MET_FLOAT, 1, (void *)_elementData, true);
...
unsigned int
MetaClassPDF::GetNumberOfFeatures(void) const
{
  return MetaImage::NDims();
}

void
MetaClassPDF::SetNumberOfBinsPerFeature(const VectorUIntType & _nBinsPerFeature)
{
  int    nBins[10];
  double binSize[10];
  ...
  MetaImage::InitializeEssential(MetaImage::NDims(), nBins, binSize, MET_FLOAT, 1, (float *)(MetaImage::ElementData()));
}

const MetaClassPDF::VectorUIntType
MetaClassPDF::GetNumberOfBinsPerFeature(void) const
{
  VectorUIntType nBinsPerFeature;
...
void
MetaClassPDF::SetBinMin(const VectorDoubleType & _binMin)
{
...
const MetaClassPDF::VectorDoubleType
MetaClassPDF::GetBinMin(void) const
{
  VectorDoubleType binMin;
...
void
MetaClassPDF::SetBinSize(const VectorDoubleType & _binSize)
{
...
const MetaClassPDF::VectorDoubleType
MetaClassPDF::GetBinSize(void) const
{
  VectorDoubleType binSize;
...
void
MetaClassPDF::SetPDF(float * _pdf)
{
  MetaImage::ElementData((float *)(_pdf));
}

float *
MetaClassPDF::GetPDF(void)
{
  return (float *)(MetaImage::ElementData());
}

float *
MetaClassPDF::ExportPDF(void)
{
...
void
MetaClassPDF::SetObjectId(const VectorIntType & _objectId)
{
  m_ObjectId = _objectId;
}

const MetaClassPDF::VectorIntType
MetaClassPDF::GetObjectId(void) const
{
  return m_ObjectId;
}

void
MetaClassPDF::SetObjectPDFWeight(const VectorDoubleType & _objectPDFWeight)
{
  m_ObjectPDFWeight = _objectPDFWeight;
}

const MetaClassPDF::VectorDoubleType
MetaClassPDF::GetObjectPDFWeight(void) const
{
  return m_ObjectPDFWeight;
}

void
MetaClassPDF::SetVoidId(int _VoidId)
{
  m_VoidId = _VoidId;
}

int
MetaClassPDF::GetVoidId(void) const
{
  return m_VoidId;
}

void
MetaClassPDF::SetErodeDilateRadius(unsigned int _ErodeDilateRadius)
{
  m_ErodeDilateRadius = _ErodeDilateRadius;
}

unsigned int
MetaClassPDF::GetErodeDilateRadius(void) const
{
  return m_ErodeDilateRadius;
}

void
MetaClassPDF::SetHoleFillIterations(unsigned int _HoleFillIterations)
{
  m_HoleFillIterations = _HoleFillIterations;
}

unsigned int
MetaClassPDF::GetHoleFillIterations(void) const
{
  return m_HoleFillIterations;
}

void
MetaClassPDF::SetProbabilityImageSmoothingStandardDeviation(double _ProbabilityImageSmoothingStandardDeviation)
{
  m_ProbabilityImageSmoothingStandardDeviation = _ProbabilityImageSmoothingStandardDeviation;
}

double
MetaClassPDF::GetProbabilityImageSmoothingStandardDeviation(void) const
{
  return m_ProbabilityImageSmoothingStandardDeviation;
}

void
MetaClassPDF::SetHistogramSmoothingStandardDeviation(double _HistogramSmoothingStandardDeviation)
{
  m_HistogramSmoothingStandardDeviation = _HistogramSmoothingStandardDeviation;
}

double
MetaClassPDF::GetHistogramSmoothingStandardDeviation(void) const
{
  return m_HistogramSmoothingStandardDeviation;
}

void
MetaClassPDF::SetOutlierRejectPortion(double _OutlierRejectPortion)
{
  m_OutlierRejectPortion = _OutlierRejectPortion;
}

double
MetaClassPDF::GetOutlierRejectPortion(void) const
{
  return m_OutlierRejectPortion;
}

void
MetaClassPDF::SetDraft(bool _Draft)
{
  m_Draft = _Draft;
}

bool
MetaClassPDF::GetDraft(void) const
{
  return m_Draft;
}

void
MetaClassPDF::SetReclassifyObjectLabels(bool _ReclassifyObjectLabels)
{
  m_ReclassifyObjectLabels = _ReclassifyObjectLabels;
}

bool
MetaClassPDF::GetReclassifyObjectLabels(void) const
{
  return m_ReclassifyObjectLabels;
}

void
MetaClassPDF::SetReclassifyNotObjectLabels(bool _ReclassifyNotObjectLabels)
{
  m_ReclassifyNotObjectLabels = _ReclassifyNotObjectLabels;
}

bool
MetaClassPDF::GetReclassifyNotObjectLabels(void) const
{
  return m_ReclassifyNotObjectLabels;
}

void
MetaClassPDF::SetForceClassification(bool _ForceClassification)
{
  m_ForceClassification = _ForceClassification;
}

bool
MetaClassPDF::GetForceClassification(void) const
{
  return m_ForceClassification;
}

bool
MetaClassPDF::CanRead(const char * _headerName) const
{
  return MetaImage::CanRead(_headerName);
}

bool
MetaClassPDF::Read(const char * _headerName)
{
  return MetaImage::Read(_headerName, true, NULL);
}

bool
MetaClassPDF::CanReadStream(METAIO_STREAM::ifstream * _stream) const
{
  return MetaImage::CanReadStream(_stream);
}

bool
MetaClassPDF::ReadStream(METAIO_STREAM::ifstream * _stream)
{
  if (META_DEBUG)
  {
  ...
  MetaClassPDF::InitializeEssential(MetaImage::NDims(), nBinsPerFeature, binMin, binSize, (float *)(m_ElementData));

  return true;
}

bool
MetaClassPDF::Write(const char * _headerName)
{
  return MetaImage::Write(_headerName);
}

bool
MetaClassPDF::WriteStream(METAIO_STREAM::ofstream * _stream)
{
  return MetaImage::WriteStream(_stream);
}

void
MetaClassPDF::M_SetupReadFields(void)
{
  if (META_DEBUG)
  {
  ...
  mF = new MET_FieldRecordType;
  MET_InitReadField(mF, "ObjectPDFWeight", MET_FLOAT_ARRAY, true, nObjects);
  m_Fields.push_back(mF);
  ...
  mF = new MET_FieldRecordType;
  MET_InitReadField(mF, "ProbabilityImageSmoothingStandardDeviation", MET_FLOAT, true);
  m_Fields.push_back(mF);

  mF = new MET_FieldRecordType;
  MET_InitReadField(mF, "HistogramSmoothingStandardDeviation", MET_FLOAT, true);
  m_Fields.push_back(mF);
...
void
MetaClassPDF::M_SetupWriteFields(void)
{
  ...
  mF = new MET_FieldRecordType;
  MET_InitWriteField(mF, "ObjectPDFWeight", MET_FLOAT_ARRAY, nObjects, tmpF);
  m_Fields.push_back(mF);
  ...
  mF = new MET_FieldRecordType;
  MET_InitWriteField(mF, "HoleFillIterations", MET_INT, m_HoleFillIterations);
  m_Fields.push_back(mF);

  mF = new MET_FieldRecordType;
  MET_InitWriteField(
    mF, "ProbabilityImageSmoothingStandardDeviation", MET_FLOAT, m_ProbabilityImageSmoothingStandardDeviation);
  m_Fields.push_back(mF);

  mF = new MET_FieldRecordType;
  MET_InitWriteField(mF, "HistogramSmoothingStandardDeviation", MET_FLOAT, m_HistogramSmoothingStandardDeviation);
  m_Fields.push_back(mF);

  mF = new MET_FieldRecordType;
  MET_InitWriteField(mF, "OutlierRejectPortion", MET_FLOAT, m_OutlierRejectPortion);
  m_Fields.push_back(mF);
  ...
  mF = new MET_FieldRecordType;
  MET_InitWriteField(mF, "ReclassifyObjectLabels", MET_STRING, std::strlen(tmpC), tmpC);
  m_Fields.push_back(mF);
  ...
  mF = new MET_FieldRecordType;
  MET_InitWriteField(mF, "ReclassifyNotObjectLabels", MET_STRING, std::strlen(tmpC), tmpC);
  m_Fields.push_back(mF);
  ...
  mF = new MET_FieldRecordType;
  MET_InitWriteField(mF, "ForceClassification", MET_STRING, std::strlen(tmpC), tmpC);
  m_Fields.push_back(mF);
...
MetaClassPDF::M_Read(void)
{
  ...
  if (META_DEBUG)
  {
    std::cout << "MetaClassPDF: M_Read: num fields = " << m_Fields.size() << std::endl;
  ...
  MET_FieldRecordType * mF = MET_GetFieldRecord("NObjects", &m_Fields);
  ...
  mF = MET_GetFieldRecord("ProbabilityImageSmoothingStandardDeviation", &m_Fields);
  if (mF && mF->defined)
  {
    m_ProbabilityImageSmoothingStandardDeviation = (double)mF->value[0];
  }

  mF = MET_GetFieldRecord("HistogramSmoothingStandardDeviation", &m_Fields);
  if (mF && mF->defined)
  {
