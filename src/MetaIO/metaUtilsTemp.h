...
=========================================================================*/
#ifndef metaUtilsTemp_h
#define metaUtilsTemp_h
...
template <class T>
bool
MET_InitWriteField_Temp(MET_FieldRecordType * _mf, const char * _name, MET_ValueEnumType _type, size_t _length, T * _v)
{
