...
MetaTubeExtractor::MetaTubeExtractor(void)
{
  if (META_DEBUG)
  {
...
//
MetaTubeExtractor::MetaTubeExtractor(const char * _headerName)
{
  if (META_DEBUG)
  {
    std::cout << "MetaTubeExtractor()" << std::endl;
...
//
MetaTubeExtractor::MetaTubeExtractor(const MetaTubeExtractor & _metaTubeExtractor)
  : MetaForm()
{
  if (META_DEBUG)
  {
...
//
MetaTubeExtractor::~MetaTubeExtractor(void) { M_Destroy(); }

//
void
MetaTubeExtractor::PrintInfo(void) const
{
  MetaForm::PrintInfo();

  std::cout << "DataMin = " << m_DataMin << std::endl;

  std::cout << "DataMax = " << m_DataMax << std::endl;

  std::cout << "TubeColor = " << m_TubeColor << std::endl;

  std::cout << "RidgeScale = " << m_RidgeScale << std::endl;

  std::cout << "RidgeScaleKernelExtent = " << m_RidgeScaleKernelExtent << std::endl;

  std::cout << "RidgeDynamicScale = " << m_RidgeDynamicScale << std::endl;

  std::cout << "RidgeDynamicStepSize = " << m_RidgeDynamicStepSize << std::endl;

  std::cout << "RidgeStepX = " << m_RidgeStepX << std::endl;

  std::cout << "RidgeMaxTangentChange = " << m_RidgeMaxTangentChange << std::endl;

  std::cout << "RidgeMaxXChange = " << m_RidgeMaxXChange << std::endl;

  std::cout << "RidgeMinRidgeness = " << m_RidgeMinRidgeness << std::endl;

  std::cout << "RidgeMinRidgenessStart = " << m_RidgeMinRidgenessStart << std::endl;

  std::cout << "RidgeMinRoundness = " << m_RidgeMinRoundness << std::endl;

  std::cout << "RidgeMinRoundnessStart = " << m_RidgeMinRoundnessStart << std::endl;

  std::cout << "RidgeMinCurvature = " << m_RidgeMinCurvature << std::endl;

  std::cout << "RidgeMinCurvatureStart = " << m_RidgeMinCurvatureStart << std::endl;

  std::cout << "RidgeMinLevelness = " << m_RidgeMinLevelness << std::endl;

  std::cout << "RidgeMinLevelnessStart = " << m_RidgeMinLevelnessStart << std::endl;

  std::cout << "RidgeMaxRecoveryAttempts = " << m_RidgeMaxRecoveryAttempts << std::endl;

  std::cout << "RadiusStart = " << m_RadiusStart << std::endl;

  std::cout << "RadiusMin = " << m_RadiusMin << std::endl;

  std::cout << "RadiusMax = " << m_RadiusMax << std::endl;

  std::cout << "RadiusMinMedialness = " << m_RadiusMinMedialness << std::endl;

  std::cout << "RadiusMinMedialnessStart = " << m_RadiusMinMedialnessStart << std::endl;
}

void
MetaTubeExtractor::SetGeneralProperties(double _dataMin, double _dataMax, const VectorType & _tubeColor)
{
  m_DataMin = _dataMin;
  m_DataMax = _dataMax;
...
void
MetaTubeExtractor::SetRidgeProperties(double _ridgeScale,
...
void
MetaTubeExtractor::SetRadiusProperties(double _radiusStart,
                                       double _radiusMin,
                                       double _radiusMax,
...
double
MetaTubeExtractor::GetDataMin(void) const
{
  return m_DataMin;
}

double
MetaTubeExtractor::GetDataMax(void) const
{
  return m_DataMax;
}

vnl_vector<double>
MetaTubeExtractor::GetTubeColor(void) const
{
  return m_TubeColor;
}

double
MetaTubeExtractor::GetRidgeScale(void) const
{
  return m_RidgeScale;
}

double
MetaTubeExtractor::GetRidgeScaleKernelExtent(void) const
{
  return m_RidgeScaleKernelExtent;
}

bool
MetaTubeExtractor::GetRidgeDynamicScale(void) const
{
  return m_RidgeDynamicScale;
}

bool
MetaTubeExtractor::GetRidgeDynamicStepSize(void) const
{
  return m_RidgeDynamicStepSize;
}

double
MetaTubeExtractor::GetRidgeStepX(void) const
{
  return m_RidgeStepX;
}

double
MetaTubeExtractor::GetRidgeMaxTangentChange(void) const
{
  return m_RidgeMaxTangentChange;
}

double
MetaTubeExtractor::GetRidgeMaxXChange(void) const
{
  return m_RidgeMaxXChange;
}

double
MetaTubeExtractor::GetRidgeMinRidgeness(void) const
{
  return m_RidgeMinRidgeness;
}

double
MetaTubeExtractor::GetRidgeMinRidgenessStart(void) const
{
  return m_RidgeMinRidgenessStart;
}

double
MetaTubeExtractor::GetRidgeMinRoundness(void) const
{
  return m_RidgeMinRoundness;
}

double
MetaTubeExtractor::GetRidgeMinRoundnessStart(void) const
{
  return m_RidgeMinRoundnessStart;
}

double
MetaTubeExtractor::GetRidgeMinCurvature(void) const
{
  return m_RidgeMinCurvature;
}

double
MetaTubeExtractor::GetRidgeMinCurvatureStart(void) const
{
  return m_RidgeMinCurvatureStart;
}

double
MetaTubeExtractor::GetRidgeMinLevelness(void) const
{
  return m_RidgeMinLevelness;
}

double
MetaTubeExtractor::GetRidgeMinLevelnessStart(void) const
{
  return m_RidgeMinLevelnessStart;
}

int
MetaTubeExtractor::GetRidgeMaxRecoveryAttempts(void) const
{
  return m_RidgeMaxRecoveryAttempts;
}

double
MetaTubeExtractor::GetRadiusStart(void) const
{
  return m_RadiusStart;
}

double
MetaTubeExtractor::GetRadiusMin(void) const
{
  return m_RadiusMin;
}

double
MetaTubeExtractor::GetRadiusMax(void) const
{
  return m_RadiusMax;
}

double
MetaTubeExtractor::GetRadiusMinMedialness(void) const
{
  return m_RadiusMinMedialness;
}

double
MetaTubeExtractor::GetRadiusMinMedialnessStart(void) const
{
  return m_RadiusMinMedialnessStart;
}

void
MetaTubeExtractor::CopyInfo(const MetaTubeExtractor & _tubeExtractor)
{
  MetaForm::CopyInfo(dynamic_cast<const MetaForm *>(&_tubeExtractor));

  SetGeneralProperties(_tubeExtractor.GetDataMin(), _tubeExtractor.GetDataMax(), _tubeExtractor.GetTubeColor());
...
void
MetaTubeExtractor::Clear(void)
{
  if (META_DEBUG)
  {
    std::cout << "MetaTubeExtractor: Clear" << std::endl;
  }
...
bool
MetaTubeExtractor::InitializeEssential(void)
{
  if (META_DEBUG)
  {
    std::cout << "MetaTubeExtractor: Initialize" << std::endl;
  }
...
//
bool
MetaTubeExtractor::CanRead(const char * _headerName) const
{
...
bool
MetaTubeExtractor::Read(const char * _headerName)
{
  ...
  {
    std::cout << "MetaTubeExtractor: Read: Cannot open file _" << m_FileName << "_" << std::endl;
    delete tmpStream;
    return false;
  }
...
bool
MetaTubeExtractor::CanReadStream(METAIO_STREAM::ifstream * _stream) const
{
...
bool
MetaTubeExtractor::ReadStream(METAIO_STREAM::ifstream * _stream)
{
  if (META_DEBUG)
  {
    std::cout << "MetaTubeExtractor: ReadStream" << std::endl;
  }
  ...
  if (m_ReadStream)
  {
    std::cout << "MetaTubeExtractor: ReadStream: two files open?" << std::endl;
    delete m_ReadStream;
  }
  ...
  if (!M_Read())
  {
    std::cout << "MetaTubeExtractor: Read: Cannot parse file" << std::endl;
    m_ReadStream = NULL;
    return false;
  }
...
bool
MetaTubeExtractor::Write(const char * _headName)
{
...
bool
MetaTubeExtractor::WriteStream(METAIO_STREAM::ofstream * _stream)
{
  if (m_WriteStream != NULL)
  {
    std::cout << "MetaTubeExtractor: WriteStream: two files open?" << std::endl;
...
void
MetaTubeExtractor::M_Destroy(void)
{
  MetaForm::M_Destroy();
}

void
MetaTubeExtractor::M_SetupReadFields(void)
{
  if (META_DEBUG)
  {
    std::cout << "MetaTubeExtractor: M_SetupReadFields" << std::endl;
  }
  ...
  mF = new MET_FieldRecordType;
  MET_InitReadField(mF, "RidgeMaxTangentChange", MET_FLOAT, true);
  m_Fields.push_back(mF);
  ...
  mF = new MET_FieldRecordType;
  MET_InitReadField(mF, "RidgeMinRidgenessStart", MET_FLOAT, true);
  m_Fields.push_back(mF);
  ...
  mF = new MET_FieldRecordType;
  MET_InitReadField(mF, "RidgeMinCurvatureStart", MET_FLOAT, true);
  m_Fields.push_back(mF);
  ...
  mF = new MET_FieldRecordType;
  MET_InitReadField(mF, "RidgeMinLevelnessStart", MET_FLOAT, true);
  m_Fields.push_back(mF);
  ...
  mF = new MET_FieldRecordType;
  MET_InitReadField(mF, "RadiusMinMedialness", MET_FLOAT, true);
  m_Fields.push_back(mF);

  mF = new MET_FieldRecordType;
  MET_InitReadField(mF, "RadiusMinMedialnessStart", MET_FLOAT, true);
  m_Fields.push_back(mF);
}

void
MetaTubeExtractor::M_SetupWriteFields(void)
{
  if (META_DEBUG)
  {
    std::cout << "MetaTubeExtractor: M_SetupWriteFields" << std::endl;
  }
  ...
  char colorString[80];
  snprintf(colorString, 79, "%f %f %f %f", m_TubeColor[0], m_TubeColor[1], m_TubeColor[2], m_TubeColor[3]);
  mF = new MET_FieldRecordType;
  MET_InitWriteField(mF, "TubeColor", MET_STRING, std::strlen(colorString), colorString);
  m_Fields.push_back(mF);
  ...
  mF = new MET_FieldRecordType;
  MET_InitWriteField(mF, "RidgeScaleKernelExtent", MET_FLOAT, m_RidgeScaleKernelExtent);
  m_Fields.push_back(mF);
  ...
  {
    MET_InitWriteField(mF, "RidgeDynamicStepSize", MET_STRING, 4, "True");
  }
  else
  {
    MET_InitWriteField(mF, "RidgeDynamicStepSize", MET_STRING, 5, "False");
  }
  m_Fields.push_back(mF);
  ...
  mF = new MET_FieldRecordType;
  MET_InitWriteField(mF, "RidgeMaxTangentChange", MET_FLOAT, m_RidgeMaxTangentChange);
  m_Fields.push_back(mF);

  mF = new MET_FieldRecordType;
  MET_InitWriteField(mF, "RidgeMaxXChange", MET_FLOAT, m_RidgeMaxXChange);
  m_Fields.push_back(mF);

  mF = new MET_FieldRecordType;
  MET_InitWriteField(mF, "RidgeMinRidgeness", MET_FLOAT, m_RidgeMinRidgeness);
  m_Fields.push_back(mF);

  mF = new MET_FieldRecordType;
  MET_InitWriteField(mF, "RidgeMinRidgenessStart", MET_FLOAT, m_RidgeMinRidgenessStart);
  m_Fields.push_back(mF);

  mF = new MET_FieldRecordType;
  MET_InitWriteField(mF, "RidgeMinRoundness", MET_FLOAT, m_RidgeMinRoundness);
  m_Fields.push_back(mF);

  mF = new MET_FieldRecordType;
  MET_InitWriteField(mF, "RidgeMinRoundnessStart", MET_FLOAT, m_RidgeMinRoundnessStart);
  m_Fields.push_back(mF);

  mF = new MET_FieldRecordType;
  MET_InitWriteField(mF, "RidgeMinCurvature", MET_FLOAT, m_RidgeMinCurvature);
  m_Fields.push_back(mF);

  mF = new MET_FieldRecordType;
  MET_InitWriteField(mF, "RidgeMinCurvatureStart", MET_FLOAT, m_RidgeMinCurvatureStart);
  m_Fields.push_back(mF);

  mF = new MET_FieldRecordType;
  MET_InitWriteField(mF, "RidgeMinLevelness", MET_FLOAT, m_RidgeMinLevelness);
  m_Fields.push_back(mF);

  mF = new MET_FieldRecordType;
  MET_InitWriteField(mF, "RidgeMinLevelnessStart", MET_FLOAT, m_RidgeMinLevelnessStart);
  m_Fields.push_back(mF);

  mF = new MET_FieldRecordType;
  MET_InitWriteField(mF, "RidgeMaxRecoveryAttempts", MET_INT, m_RidgeMaxRecoveryAttempts);
  m_Fields.push_back(mF);

  mF = new MET_FieldRecordType;
  MET_InitWriteField(mF, "RadiusStart", MET_FLOAT, m_RadiusStart);
  m_Fields.push_back(mF);
  ...
  mF = new MET_FieldRecordType;
  MET_InitWriteField(mF, "RadiusMinMedialness", MET_FLOAT, m_RadiusMinMedialness);
  m_Fields.push_back(mF);

  mF = new MET_FieldRecordType;
  MET_InitWriteField(mF, "RadiusMinMedialnessStart", MET_FLOAT, m_RadiusMinMedialnessStart);
  m_Fields.push_back(mF);
}


bool
MetaTubeExtractor::M_Read(void)
{
  if (META_DEBUG)
  {
    std::cout << "MetaTubeExtractor: M_Read: Loading Header" << std::endl;
  }
  if (!MetaForm::M_Read())
  {
    std::cout << "MetaTubeExtractor: M_Read: Error parsing file" << std::endl;
    return false;
  }

  if (META_DEBUG)
  {
    std::cout << "MetaTubeExtractor: M_Read: Parsing Header" << std::endl;
  }
  MET_FieldRecordType * mF;
  ...
  mF = MET_GetFieldRecord("RadiusMinMedialnessStart", &m_Fields);
