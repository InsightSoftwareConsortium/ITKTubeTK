...
export inputImageIntensityMin=-4096
export inputImageIntensityMax=1024

export bufferRadius=4

export scales="0.5,1,3,5,7"
...
echo "   Mapping from $inputImageIntensityMin - $inputImageIntensityMax to 1 - 0"
ImageMath $1 -i $inputImageIntensityMin $inputImageIntensityMax 1 0 -w $3.input.mha > $3.trainLog.txt
