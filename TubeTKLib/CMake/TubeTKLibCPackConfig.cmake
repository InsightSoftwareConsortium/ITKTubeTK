...
#
##############################################################################
# Record ITK, VTK, and other libraries used by TubeTKLib for
# packaging.
...
if( TubeTKLib_USE_LIBSVM )
  file( GLOB_RECURSE LIBSVM_BINARIES "${LIBSVM_DIR}/bin/lib*" )
endif( TubeTKLib_USE_LIBSVM )
if( TubeTKLib_USE_RANDOMFOREST )
  file( GLOB_RECURSE RANDOMFOREST_BINARIES "${RANDOMFOREST_DIR}/bin/lib*" )
endif( TubeTKLib_USE_RANDOMFOREST )
if( TubeTKLib_USE_ARRAYFIRE )
  file( GLOB_RECURSE ARRAYFIRE_BINARIES "${ARRAYFIRE_DIR}/bin/lib*" )
endif( TubeTKLib_USE_ARRAYFIRE )
list( APPEND TubeTKLib_SUPPORT_BINARIES
  ${VTK_BINARIES} ${LIBSVM_BINARIES} ${RANDOMFOREST_BINARIES}
  ${ARRAYFIRE_BINARIES}$ {ITK_BINARIES} )
install( FILES ${TubeTKLib_SUPPORT_BINARIES}
  DESTINATION lib
  COMPONENT Runtime)

# Record the environment setup files for packaging.
set( TubeTKLib_LINUX_SETUP
  ${TubeTKLib_SOURCE_DIR}/CMake/TubeTKLibSourceMeToSetupLinux.sh )
set( TubeTKLib_WINDOWS_SETUP
  ${TubeTKLib_SOURCE_DIR}/CMake/TubeTKLibRunMeToSetupWindows.bat )

include( InstallRequiredSystemLibraries )

set( CPACK_PACKAGE_DESCRIPTION_SUMMARY
  "TubeTKLib for the analysis of geometric structures in images." )
set( CPACK_PACKAGE_VENDOR "Kitware, Inc." )
set( CPACK_PACKAGE_DESCRIPTION_FILE
  "${TubeTKLib_SOURCE_DIR}/CMake/CPack/DESCRIPTION.txt" )
set( CPACK_RESOURCE_FILE_LICENSE
  "${TubeTKLib_SOURCE_DIR}/CMake/CPack/LICENSE.txt" )
...
if( WIN32 AND NOT UNIX )
  ...
  set( CPACK_PACKAGE_ICON "${TubeTKLib_SOURCE_DIR}\\\\Icon.png" )
  set( CPACK_NSIS_INSTALLED_ICON_NAME "bin\\\\TubeTKLib.exe" )
  set( CPACK_NSIS_DISPLAY_NAME "${CPACK_PACKAGE_INSTALL_DIRECTORY} TubeTKLib" )
...
set( CPACK_SOURCE_PACKAGE_FILE_NAME "TubeTKLib" )
