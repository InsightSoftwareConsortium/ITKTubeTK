...
1)  Compile TubeTKLib with RelWithDebInfo CMAKE_BUILD_TYPE

2)  cd into  the TubeTKLib binary build directory
...
4)  Type the path to this script in the TubeTKLib source tree and add the select expression
    from step 3 above.

For example:

   ~/src/TubeTK/TubeTKLib/CMake/Valgrind/runValgrind.sh    \
