...
int itktubeTubeParametricExponentialWithBoundsResolutionWeightFunctionTest( int argc, char * argv[] )
{
  if( argc < 2 )
    {
    std::cerr << "Usage: "
  ...
  typedef itk::tube::Function::TubeParametricExponentialWithBoundsResolutionWeightFunction< TubePointType, float >
    WeightFunctionType;
