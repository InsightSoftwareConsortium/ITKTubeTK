 ...
 *
 *=========================================================================*/
#ifndef itkTubeScaleSkewVersor3DTransform_h
#define itkTubeScaleSkewVersor3DTransform_h
...
namespace itk
{
/** \class TubeScaleSkewVersor3DTransform
 * \brief TubeScaleSkewVersor3DTransform of a vector space (e.g. space coordinates)
 *
...
class ITK_TEMPLATE_EXPORT TubeScaleSkewVersor3DTransform :
  public VersorRigid3DTransform<TParametersValueType>
{
public:
  /** Standard class typedefs. */
  typedef TubeScaleSkewVersor3DTransform               Self;
  ...
  itkTypeMacro(TubeScaleSkewVersor3DTransform, VersorRigid3DTransform);
...
protected:
  ...
  TubeScaleSkewVersor3DTransform(const MatrixType & matrix, const OutputVectorType & offset);
  TubeScaleSkewVersor3DTransform(unsigned int paramDims);
  ~TubeScaleSkewVersor3DTransform()
  {
  }
...
private:
  ITK_DISALLOW_COPY_AND_ASSIGN(TubeScaleSkewVersor3DTransform);
...
#include "itkTubeScaleSkewVersor3DTransform.txx"
#endif

#endif /* __TubeScaleSkewVersor3DTransform_h */
