...
EnhanceTubesUsingDiscriminantAnalysis --saveDiscriminantInfo $3.mrs --outputSeedScaleImage $3.inputEnhScales.mha --tubeScales $scales --labelmap $3.tubeMask.mha $3.input.mha $3.inputEnh.mha >> $3.trainLog.txt
