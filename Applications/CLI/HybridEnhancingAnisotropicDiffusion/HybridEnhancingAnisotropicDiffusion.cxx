...
#include "HybridEnhancingAnisotropicDiffusionCLP.h"
...
int DoIt( int argc, char * argv[] )
{
  ...
  typedef itk::AnisotropicHybridDiffusionImageFilter< InputImageType,
                                            OutputImageType>  HybridEnhancingFilterType;
  ...
  HybridEnhancingFilter->SetInput( reader->GetOutput() );
  ...
  writer->SetInput ( HybridEnhancingFilter->GetOutput() );
