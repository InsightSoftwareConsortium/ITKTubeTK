...
# Configure a project for downloading test data from a Midas server. Include
# this module in the top CMakeLists.txt file of a project to enable the
# downloading test data from Midas. Requires CTest module.
#
#   project( MyProject )
#   ...
#   include( CTest )
...
#
#   Midas3FunctionAddTest( <testName> <program> [args...] )
#
...
#         MIDAS{foo.ext.md5}, the actual file foo.ext will be substituted for
#         it at test time once the file is downloaded, assuming the keyfile
#         foo.ext.md5 exists in MIDAS_KEY_DIR. If an arg is of the form
#         MIDAS_FETCH_ONLY{foo.ext.md5}, it will be downloaded prior to running
#         the test, but it will not be passed as an argument to the test.
#
# Example:
#
#   Midas3FunctionAddTest( someTest php MIDAS{test.php.md5} )
#
#   is analogous to
#
#   add_test( someTest php test.php )
#
#   if the file test.php already exists on disk.
#
# Note:
#
...
function( Midas3FunctionAddTest )
  ...
  foreach( arg ${ARGN} )
    ...
    else( NOT arg MATCHES "MIDAS[a-zA-Z_]*{[^}]*}" )
...
if( NOT EXISTS \"${MIDAS_DATA_DIR}/MIDAS_Hashes/${checksum}\" )
  ...
  if( NOT \"${MIDAS_USER}\" STREQUAL \"\" AND NOT \"${MIDAS_DEFAULT_API_KEY}\" STREQUAL \"\" )
    ...
    else( tokenlength EQUAL 40 )
      message( FATAL_ERROR \"Invalid authentication token: \${token}\" )
    endif( tokenlength EQUAL 40 )
  endif( NOT \"${MIDAS_USER}\" STREQUAL \"\" AND NOT \"${MIDAS_DEFAULT_API_KEY}\" STREQUAL \"\" )
