  ...
  if("x${CMAKE_OSX_DEPLOYMENT_TARGET}x" STREQUAL "xx")
    ...
    if( "${SDK_VERSION}" VERSION_GREATER "10.8" )
      ...
      if( "x${QMAKE_USE_STDC}x" strequal "xx" )
        set(CMAKE_OSX_DEPLOYMENT_TARGET "10.8" CACHE PATH "Deployment target needs to be explicitly set." FORCE)
      else()
        set(CMAKE_OSX_DEPLOYMENT_TARGET "${SDK_VERSION}" CACHE PATH "Deployment target needs to be explicitly set." FORCE)
      endif()
    endif()
  endif()
