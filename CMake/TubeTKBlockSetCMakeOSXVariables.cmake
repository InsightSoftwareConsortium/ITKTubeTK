...
if( APPLE )
  ...
  if( NOT "${CMAKE_OSX_ARCHITECTURES}" STREQUAL "" )
    ...
    if( arch_count GREATER 1 )
      message( FATAL_ERROR
        "error: Only one value (i386 or x86_64 ) should be associated with CMAKE_OSX_ARCHITECTURES.")
    endif()
  endif()
      ...
      if( NOT "x${SDK_SYSROOTS}x" STREQUAL "xx" )
        ...
        if( NOT "x${SDK_SYSROOT_NEWEST}x" STREQUAL "xx" )
          ...
          set( CMAKE_OSX_ARCHITECTURES "x86_64" CACHE STRING
            "Force build for 64-bit ${OSX_NAME}." FORCE )
          set( CMAKE_OSX_SYSROOT "${SDK_SYSROOT_NEWEST}" CACHE PATH
            "Force build for 64-bit ${OSX_NAME}." FORCE )
          message( STATUS
            "Setting OSX_ARCHITECTURES to '${CMAKE_OSX_ARCHITECTURES}' as none specified." )
          message( STATUS
            "Setting OSX_SYSROOT to '${CMAKE_OSX_SYSROOT}' as none specified." )
        endif()
      endif()
    endif()
  endforeach()
  ...
  if( NOT "${CMAKE_OSX_SYSROOT}" STREQUAL "" )
    if( NOT EXISTS "${CMAKE_OSX_SYSROOT}" )
      message( FATAL_ERROR
        "error: CMAKE_OSX_SYSROOT='${CMAKE_OSX_SYSROOT}' does not exist" )
    endif()
  endif()
