...
message( WARNING "Running ${SCRIPT_NAME} script..." )
...
file( WRITE "${TUBETK_BINARY_DIR}/CMakeCache.txt" "
  ...
  CMAKE_PROJECT_NAME:STATIC=TubeTK
  ...
  TubeTK_BINARY_DIR:STATIC=${TUBETK_BINARY_DIR}
  TubeTK_SOURCE_DIR:STATIC=${TUBETK_SOURCE_DIR}
  TubeTK_USE_SUPERBUILD:BOOL=ON
  TubeTK_USE_KWSTYLE:BOOL=ON
  TubeTK_USE_QT:BOOL=ON
  " )
