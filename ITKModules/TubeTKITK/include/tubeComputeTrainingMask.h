...
public:
    ...
    typedef typename itk::tube::ComputeTrainingMaskFilter< ImageType > FilterType;
    ...
    tubeWrapGetConstObjectMacro(NotVesselMask,ImageTypeShort,ComputeTrainingMaskFilter);
    tubeWrapSetConstObjectMacro(Input,ImageType,ComputeTrainingMaskFilter);
    tubeWrapCallMacro(Update,ComputeTrainingMaskFilter);

    tubeWrapGetObjectMacro(Output,ImageTypeShort,ComputeTrainingMaskFilter);
