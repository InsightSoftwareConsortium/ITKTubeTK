...
1)  Compile TubeTK with RelWithDebInfo CMAKE_BUILD_TYPE

2)  cd into  the TubeTK binary build directory
...
4)  Type the path to this script in the TubeTK source tree and add the select expression
    from step 3 above.
